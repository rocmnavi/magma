...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zbajac_csr_overlap.hip.cpp, normal z -> s, Thu Jan 25 22:58:29 2024
    ...
    magma_queue_t queue )
{
    ...
    if ( min_nnz > -1 ){ 
        if ( matrices == 1 ){
            ...
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel1, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel2, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
                    D[1].dval, D[1].drow, D[1].dcol, R[1].dval, R[1].drow, R[1].dcol,
                    b.dval, x->dval );  
               //magma_sbajac_csr_o_ls_kernel<<< grid, block, 0, queue->hip_stream() >>>
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel4, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
                    D[1].dval, D[1].drow, D[1].dcol, R[1].dval, R[1].drow, R[1].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel8, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
                    D[1].dval, D[1].drow, D[1].dcol, R[1].dval, R[1].drow, R[1].dcol,
                    D[2].dval, D[2].drow, D[2].dcol, R[2].dval, R[2].drow, R[2].dcol,
                    D[3].dval, D[3].drow, D[3].dcol, R[3].dval, R[3].drow, R[3].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel16, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
                    D[ 3].dval, D[ 3].drow, D[ 3].dcol, R[ 3].dval, R[ 3].drow, R[ 3].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel32, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
                    D[ 3].dval, D[ 3].drow, D[ 3].dcol, R[ 3].dval, R[ 3].drow, R[ 3].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            hipLaunchKernelGGL(magma_sbajac_csr_o_ls_kernel64, dim3(grid), dim3(block), 0, queue->hip_stream() ,  localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
                    D[ 3].dval, D[ 3].drow, D[ 3].dcol, R[ 3].dval, R[ 3].drow, R[ 3].dcol,
