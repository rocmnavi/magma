...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zlobpcg_maxpy.hip.cpp, normal z -> d, Fri Aug 25 13:17:47 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_dlobpcg_maxpy_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  num_rows, num_vecs, X, Y );
