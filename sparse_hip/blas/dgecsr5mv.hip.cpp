...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgecsr5mv.hip.cpp, normal z -> d, Mon Oct 28 11:12:55 2024
       @author Weifeng Liu
    ...
    magma_queue_t           queue )
{
    ...
    if ( arch >= 600 ) {
        ...
        //dgecsrmv_kernel<<< grid, threads, 0, queue->hip_stream() >>>
        ...
        hipLaunchKernelGGL(dgecsr5mv_kernel_update_y, dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , m, beta, dy);
        ...
        {
        case 4:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<4>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 5:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<5>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 6:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<6>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 7:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<7>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 8:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<8>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 9:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<9>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 10:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<10>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
    
        case 11:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<11>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 12:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<12>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 13:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<13>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 14:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<14>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 15:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<15>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 16:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<16>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 17:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<17>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 18:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<18>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 19:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<19>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 20:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<20>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
    
        case 21:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<21>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 22:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<22>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 23:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<23>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 24:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<24>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 25:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<25>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 26:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<26>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 27:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<27>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 28:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<28>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 29:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<29>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 30:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<30>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
    
        case 31:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<31>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        case 32:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(spmv_csr5_compute_kernel<32>), dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dcolind, dval, drowptr, dx, dtile_ptr, dtile_desc, 
                 dtile_desc_offset_ptr, dtile_desc_offset, dcalibrator, dy, p, 
                 num_packet, bit_y_offset, bit_scansum_offset, alpha);
            break;
        }
        ...
        hipLaunchKernelGGL(spmv_csr5_calibrate_kernel, dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , dtile_ptr, dcalibrator, dy, p);
    
        num_threads = MAGMA_CSR5_OMEGA;
        num_blocks = m - tail_tile_start;
    
        hipLaunchKernelGGL(spmv_csr5_tail_tile_kernel, dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , drowptr, dcolind, dval, dx, dy,
