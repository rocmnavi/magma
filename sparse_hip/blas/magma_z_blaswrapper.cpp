...
#else
#define hipsparseZcsrmv(handle, op, rows, cols, nnz, alpha, descr, dval, drow, dcol, x, beta, y) \
    CHECK_CUSPARSE(hipsparseZcsrmv(handle,op,rows,cols,nnz,alpha,descr,dval,drow,dcol,x,beta,y))
#endif

#if CUDA_VERSION >= 11000
#define hipsparseZcsrmm(handle, op, rows, num_vecs, cols, nnz, alpha, descr, dval, drow, dcol,   \
                       x, ldx, beta, y, ldy)                                                    \
    {                                                                                           \
        hipsparseSpMatDescr_t descrA=NULL;                                                       \
    ...
    if ( A.memory_location == Magma_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
                 ...
                 A.storage_type == Magma_CSRU )
            {
                ...
                hipsparseZcsrmv( hipsparseHandle,HIPSPARSE_OPERATION_NON_TRANSPOSE,
                                A.num_rows, A.num_cols, A.nnz, (hipblasDoubleComplex*)&alpha, descr,
                                (hipblasDoubleComplex*)A.dval, A.drow, A.dcol, (hipblasDoubleComplex*)x.dval, (hipblasDoubleComplex*)&beta, (hipblasDoubleComplex*)y.dval );
            }
            else if ( A.storage_type == Magma_CSC )
            {
                ...
                hipsparseZcsrmv( hipsparseHandle,HIPSPARSE_OPERATION_TRANSPOSE,
                              A.num_rows, A.num_cols, A.nnz, (hipblasDoubleComplex*)&alpha, descr,
                              (hipblasDoubleComplex*)A.dval, A.drow, A.dcol, (hipblasDoubleComplex*)x.dval, (hipblasDoubleComplex*)&beta, (hipblasDoubleComplex*)y.dval );
            }
               ...
               hipsparseHandle = magma_queue_get_hipsparse_handle( queue );
               CHECK_CUSPARSE( hipsparseCreateMatDescr( &descr ));
               hipsparseZbsrmv( hipsparseHandle, dirA,
                   HIPSPARSE_OPERATION_NON_TRANSPOSE, mb, nb, A.numblocks,
                   (hipblasDoubleComplex*)&alpha, descr, (hipblasDoubleComplex*)A.dval, A.drow, A.dcol, A.blocksize, (hipblasDoubleComplex*)x.dval,
                   (hipblasDoubleComplex*)&beta, (hipblasDoubleComplex*)y.dval );
            }
            else {
            ...
            if ( A.storage_type == Magma_CSR ) {
                ...
                if ( x.major == MagmaColMajor) {
                    hipsparseZcsrmm(hipsparseHandle,
                                   HIPSPARSE_OPERATION_NON_TRANSPOSE,
                                   A.num_rows,   num_vecs, A.num_cols, A.nnz,
                                   (hipblasDoubleComplex*)&alpha, descr, (hipblasDoubleComplex*)A.dval, A.drow, A.dcol,
                                   (hipblasDoubleComplex*)x.dval, A.num_cols, (hipblasDoubleComplex*)&beta, (hipblasDoubleComplex*)y.dval, A.num_cols);
                } else if ( x.major == MagmaRowMajor) {
                    /*hipsparseZcsrmm2(hipsparseHandle,
                    HIPSPARSE_OPERATION_NON_TRANSPOSE,
                    ...
                    */
                ...
                } else if ( A.storage_type == Magma_CSC )
                    {
                        ...
                        hipsparseZcsrmm( hipsparseHandle,HIPSPARSE_OPERATION_TRANSPOSE,
                                        A.num_rows,   num_vecs, A.num_cols, A.nnz,
                                        (hipblasDoubleComplex*)&alpha, descr, (hipblasDoubleComplex*)A.dval, A.drow, A.dcol,
                                        (hipblasDoubleComplex*)x.dval, A.num_cols, (hipblasDoubleComplex*)&beta, (hipblasDoubleComplex*)y.dval, A.num_cols);
                    }
