...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgecsrreimsplit.hip.cpp, normal z -> c, Mon Jul 15 16:58:13 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cgecsrreimsplit_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, A.row, A.dval, ReA->dval, ImA->dval );
