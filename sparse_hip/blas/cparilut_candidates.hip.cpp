...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zparilut_candidates.hip.cpp, normal z -> c, Thu Jan 25 22:58:35 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cparilut_candidates_count_1, dim3(grid1), dim3(block1), 0, queue->hip_stream(), 
        L0.num_rows, L0.drow, L0.dcol, U0.drow, U0.dcol,
        L.drow, L.dcol, U.drow, U.dcol,
        insertedL, insertedU);
    hipLaunchKernelGGL(cparilut_candidates_count_2, dim3(grid1), dim3(block1), 0, queue->hip_stream(), 
        L0.num_rows, L0.drow, L0.dcol, U0.drow, U0.dcol,
        L.drow, L.dcol, U.drow, U.dcol,
        insertedL, insertedU);
    ...
    hipLaunchKernelGGL(cparilut_candidates_insert_1, dim3(grid1), dim3(block1), 0, queue->hip_stream(), 
        L0.num_rows, L0.drow, L0.dcol, U0.drow, U0.dcol,
        L.drow, L.dcol, U.drow, U.dcol,
        L_new->drow, L_new->drowidx, L_new->dcol, L_new->dval, insertedL,
        U_new->drow, U_new->drowidx, U_new->dcol, U_new->dval, insertedU);
    hipLaunchKernelGGL(cparilut_candidates_insert_2, dim3(grid1), dim3(block1), 0, queue->hip_stream(), 
        L0.num_rows, L0.drow, L0.dcol, U0.drow, U0.dcol,
        L.drow, L.dcol, U.drow, U.dcol,
        L_new->drow, L_new->drowidx, L_new->dcol, L_new->dval, insertedL,
        U_new->drow, U_new->drowidx, U_new->dcol, U_new->dval, insertedU);
