...
void launch_sampleselect_nodp(hipStream_t stream, double* __restrict__ in, double* __restrict__ tmp, double* __restrict__ tree,
                                    double* __restrict__ out, int32_t* __restrict__ count_tmp, int32_t size, int32_t rank) {
...
void sampleselect_tailcall_nodp(hipStream_t stream, double* __restrict__ in, double* __restrict__ tmp, double* __restrict__ tree,
    int32_t* __restrict__ count_tmp, double* __restrict__ out) {
    //if (threadIdx.x != 0) {
    //    return;
    //}
...
void sampleselect_nodp(hipStream_t stream, double* __restrict__ in, double* __restrict__ tmp, double* __restrict__ tree,
    int32_t* __restrict__ count_tmp, int32_t size, int32_t rank, double* __restrict__ out) {
