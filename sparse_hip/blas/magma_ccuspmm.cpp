/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zcuspmm.cpp, normal z -> c, Mon Jul 15 16:58:11 2024
       @author Hartwig Anzt
...
#define hipsparseXcsrgemmNnz(handle, transA, transB, m, n, k, descrA, nnzA, drowA, dcolA,        \
    ...
    {                                                                                           \
        ...
        size_t bufsize;                                                                         \
        void *buf;                                                                              \
        hipblasComplex alpha = MAGMA_C_ONE, *beta = NULL;                                      \
...
#define hipsparseCcsrgemm(handle, transA, transB, m, n, k, descrA, nnzA, dvalA, drowA, dcolA,    \
                         descrB, nnzB, dvalB, drowB, dcolB, descrC, dvalC, drowC, dcolC )       \
    {                                                                                           \
        hipsparseMatDescr_t descrD;                                                              \
        int nnzD, *drowD, *dcolD;                                                               \
        hipblasComplex *dvalD, alpha = MAGMA_C_ONE, *beta = NULL;                              \
        void *buf;                                                                              \
        csrgemm2Info_t linfo = NULL;                                                            \
        printf("hipsparseCcsrgemm bufsize = %d\n", -1);                                          \
