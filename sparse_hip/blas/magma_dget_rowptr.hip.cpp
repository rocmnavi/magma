...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zget_rowptr.hip.cpp, normal z -> d, Mon Oct 28 11:13:03 2024
    ...
    magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(magma_dget_row_ptr_kernel, dim3(grid), dim3(block), 0, queue->hip_stream(), num_rows, nnz_dev, rowidx, rowptr);
