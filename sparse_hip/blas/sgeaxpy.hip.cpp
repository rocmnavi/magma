...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zgeaxpy.hip.cpp, normal z -> s, Fri Aug 25 13:17:45 2023
    ...
    magma_queue_t queue )
{
    ...
    if( X.storage_type == Magma_DENSE && Y->storage_type == Magma_DENSE ){
        ...
        hipLaunchKernelGGL(sgeaxpy_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, X.dval, beta, Y->dval );
