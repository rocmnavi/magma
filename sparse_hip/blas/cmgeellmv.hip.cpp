...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zmgeellmv.hip.cpp, normal z -> c, Thu Jan 25 22:58:33 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cmgeellmv_kernel, dim3(grid), dim3(threads), MEM_SIZE, queue->hip_stream() ,  m, n, num_vecs, nnz_per_row, alpha, dval, dcolind, dx, beta, dy );
