...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgesellcmv.hip.cpp, normal z -> s, Mon Jul 15 16:58:08 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sgesellcmv_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, blocksize, alpha,
