...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zjaccard_weights.hip.cpp, normal z -> c, Fri Aug 25 13:17:55 2023
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_cjaccardweights_kernel, dim3(grid), dim3(block), 0, queue->hip_stream() ,  
        m, n, nnz, 
        J->drowidx,
        J->dcol,
        J->dval,
