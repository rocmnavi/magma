    ...
    magma_queue_t queue )
{
    ...
    if( uplotype == MagmaLower ){
        //hipProfilerStart();
        hipLaunchKernelGGL(ztrsv_lower_kernel_switch, dim3(grid), dim3(block), 0, queue->hip_stream() , 
                trisystems,
                rhs,
                sizes,
                LC.num_rows );
        ...
        hipLaunchKernelGGL(ztrsv_upper_kernel_switch, dim3(grid), dim3(block), 0, queue->hip_stream() , 
                trisystems,
                rhs,
                sizes,
                LC.num_rows );
