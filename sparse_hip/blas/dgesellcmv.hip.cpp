...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgesellcmv.hip.cpp, normal z -> d, Mon Oct 28 11:12:57 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dgesellcmv_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, blocksize, alpha,
