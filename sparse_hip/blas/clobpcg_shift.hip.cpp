...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zlobpcg_shift.hip.cpp, normal z -> c, Thu Jan 25 22:58:30 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_clobpcg_shift_kernel, dim3(grid), dim3(block), Ms, queue->hip_stream() ,  num_rows, num_vecs, shift, x );
