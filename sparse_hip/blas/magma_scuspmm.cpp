/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zcuspmm.cpp, normal z -> s, Thu Jan 25 22:58:34 2024
       @author Hartwig Anzt
...
#define hipsparseXcsrgemmNnz(handle, transA, transB, m, n, k, descrA, nnzA, drowA, dcolA,        \
    ...
    {                                                                                           \
        ...
        hipsparseScsrgemm2_bufferSizeExt(handle, m, n, k, &alpha,                                \
...
#define hipsparseScsrgemm(handle, transA, transB, m, n, k, descrA, nnzA, dvalA, drowA, dcolA,    \
    ...
    {                                                                                           \
        ...
        void *buf;                                                                              \
        csrgemm2Info_t linfo = NULL;                                                            \
        printf("hipsparseScsrgemm bufsize = %d\n", -1);                                          \
        hipsparseScsrgemm2(handle, m, n, k, &alpha,                                              \
