...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/magma_zdiagcheck.hip.cpp, normal z -> c, Fri Aug 25 13:17:54 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(zdiagcheck_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  dA.num_rows, dA.num_cols, dA.dval, dA.drow, dA.dcol, dinfo );
    info = hinfo[0];
