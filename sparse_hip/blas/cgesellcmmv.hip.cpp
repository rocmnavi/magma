...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zgesellcmmv.hip.cpp, normal z -> c, Fri Aug 25 13:17:46 2023
    ...
    dim3 grid( dimgrid1, dimgrid2, 1);
        ...
        if ( alignment == 1) {
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_1<true>), dim3(grid2), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_1<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        } else if ( alignment == 4){
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_4_tex<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_4_tex<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_8_tex<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_8_tex<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_16_tex<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_16_tex<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_32_tex<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_32_tex<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
        ...
        if ( alignment == 1) {
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_1<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_1<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_4<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_4<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_8<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_8<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_16<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_16<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_C_ZERO) {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_32<true>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                hipLaunchKernelGGL(HIP_KERNEL_NAME(zgesellptmv2d_kernel_32<false>), dim3(grid), dim3(block), Ms, queue->hip_stream() ,  m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        }
