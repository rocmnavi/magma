    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(zcompact_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(zcompactactive_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
            m, n, dA, ldda, active);
    return info;
}
