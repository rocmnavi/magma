...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zlobpcg_residuals.hip.cpp, normal z -> d, Thu Jan 25 22:58:31 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_dlobpcg_res_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  num_rows, num_vecs, evalues, X, R, res );
