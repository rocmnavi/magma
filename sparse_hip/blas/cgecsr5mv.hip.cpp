...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgecsr5mv.hip.cpp, normal z -> c, Mon Oct 28 11:12:55 2024
       @author Weifeng Liu
    ...
    magma_queue_t           queue )
{
    ...
    if ( arch >= 600 ) {
        ...
        //cgecsrmv_kernel<<< grid, threads, 0, queue->hip_stream() >>>
        ...
        hipLaunchKernelGGL(cgecsr5mv_kernel_update_y, dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , m, beta, dy);
