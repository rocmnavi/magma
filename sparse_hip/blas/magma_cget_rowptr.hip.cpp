...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/magma_zget_rowptr.hip.cpp, normal z -> c, Fri Aug 25 13:17:55 2023
    ...
    magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(magma_cget_row_ptr_kernel, dim3(grid), dim3(block), 0, queue->hip_stream(), num_rows, nnz_dev, rowidx, rowptr);
