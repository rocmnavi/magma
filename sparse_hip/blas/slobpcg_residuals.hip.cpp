...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zlobpcg_residuals.hip.cpp, normal z -> s, Mon Jul 15 16:58:09 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_slobpcg_res_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  num_rows, num_vecs, evalues, X, R, res );
