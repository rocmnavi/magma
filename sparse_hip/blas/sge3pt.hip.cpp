...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zge3pt.hip.cpp, normal z -> s, Fri Aug 25 13:17:56 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sge3pt_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, beta, dx, dy );
