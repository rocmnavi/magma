...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zcompact.hip.cpp, normal z -> d, Thu Jan 25 22:58:37 2024
       @author Stan Tomov
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dcompact_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dcompactactive_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
            m, n, dA, ldda, active);
    return info;
}
