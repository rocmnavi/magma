...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zmgecsrmv.hip.cpp, normal z -> s, Mon Oct 28 11:13:00 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(smgecsrmv_kernel, dim3(grid), dim3(threads), MEM_SIZE, queue->hip_stream(), m, n, num_vecs, alpha, dval, drowptr, dcolind, dx, beta, dy);
