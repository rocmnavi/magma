/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_z_blaswrapper.cpp, normal z -> d, Mon Oct 28 11:12:53 2024
       @author Hartwig Anzt
...
#else
#define hipsparseDcsrmv(handle, op, rows, cols, nnz, alpha, descr, dval, drow, dcol, x, beta, y) \
    CHECK_CUSPARSE(hipsparseDcsrmv(handle,op,rows,cols,nnz,alpha,descr,dval,drow,dcol,x,beta,y))
#endif
    ...
    if ( A.memory_location == Magma_DEV ) {
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
            ...
            else if ( A.storage_type == Magma_CSC )
            {
                ...
                hipsparseDcsrmv( hipsparseHandle,HIPSPARSE_OPERATION_TRANSPOSE,
                              A.num_rows, A.num_cols, A.nnz, (double*)&alpha, descr,
                              (double*)A.dval, A.drow, A.dcol, (double*)x.dval, (double*)&beta, (double*)y.dval );
            }
               ...
               hipsparseHandle = magma_queue_get_hipsparse_handle( queue );
               CHECK_CUSPARSE( hipsparseCreateMatDescr( &descr ));
               hipsparseDbsrmv( hipsparseHandle, dirA,
            ...
            if ( A.storage_type == Magma_CSR ) {
                ...
                if ( x.major == MagmaColMajor) {
                    ...
                    /*hipsparseDcsrmm2(hipsparseHandle,
                    HIPSPARSE_OPERATION_NON_TRANSPOSE,
                    ...
                    */
                ...
                } else if ( A.storage_type == Magma_CSC )
                    {
                        ...
                        hipsparseDcsrmm( hipsparseHandle,HIPSPARSE_OPERATION_TRANSPOSE,
                                        A.num_rows,   num_vecs, A.num_cols, A.nnz,
                                        (double*)&alpha, descr, (double*)A.dval, A.drow, A.dcol,
                                        (double*)x.dval, A.num_cols, (double*)&beta, (double*)y.dval, A.num_cols);
                    }
