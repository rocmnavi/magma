...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zlobpcg_shift.hip.cpp, normal z -> s, Fri Aug 25 13:17:47 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_slobpcg_shift_kernel, dim3(grid), dim3(block), Ms, queue->hip_stream() ,  num_rows, num_vecs, shift, x );
