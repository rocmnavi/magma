...
/*
    -- MAGMA (version 1.1) --
       ...
       @generated from sparse_hip/blas/zgeisai_trsv.hip.cpp, normal z -> s, Mon Oct 28 11:13:04 2024
    ...
    magma_queue_t queue )
{
    ...
    if( uplotype == MagmaLower ){
        //hipProfilerStart();
        hipLaunchKernelGGL(strsv_lower_kernel_switch, dim3(grid), dim3(block), 0, queue->hip_stream() , 
                trisystems,
                rhs,
                sizes,
                LC.num_rows );
        ...
        hipLaunchKernelGGL(strsv_upper_kernel_switch, dim3(grid), dim3(block), 0, queue->hip_stream() , 
                trisystems,
                rhs,
                sizes,
                LC.num_rows );
