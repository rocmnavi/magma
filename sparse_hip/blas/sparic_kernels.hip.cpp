...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zparic_kernels.hip.cpp, normal z -> s, Fri Aug 25 13:17:52 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_sparic_csr_kernel, dim3(grid), dim3(block), 0, queue->hip_stream() ,  A.num_rows, A.nnz, 
