...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zcompact.hip.cpp, normal z -> c, Mon Jul 15 16:58:12 2024
       @author Stan Tomov
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(ccompact_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(ccompactactive_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
            m, n, dA, ldda, active);
    return info;
}
