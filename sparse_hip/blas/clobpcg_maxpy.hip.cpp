...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zlobpcg_maxpy.hip.cpp, normal z -> c, Mon Oct 28 11:12:58 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_clobpcg_maxpy_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  num_rows, num_vecs, X, Y );
