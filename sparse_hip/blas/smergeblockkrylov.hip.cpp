...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zmergeblockkrylov.hip.cpp, normal z -> s, Thu Jan 25 22:58:38 2024
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_smergeblockkrylov_kernel, dim3(Gs), dim3(Bs), 0, queue->hip_stream() ,  num_rows, num_cols, alpha, p, x );
