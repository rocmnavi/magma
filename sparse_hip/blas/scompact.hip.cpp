...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zcompact.hip.cpp, normal z -> s, Mon Oct 28 11:13:03 2024
       @author Stan Tomov
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(scompact_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(scompactactive_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , 
            m, n, dA, ldda, active);
    return info;
}
