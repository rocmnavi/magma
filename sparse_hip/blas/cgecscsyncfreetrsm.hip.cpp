...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgecscsyncfreetrsm.hip.cpp, normal z -> c, Mon Jul 15 16:58:14 2024
       @author Weifeng Liu
    ...
    magma_queue_t           queue )
{
    ...
    hipLaunchKernelGGL(sptrsv_syncfree_analyser, dim3(num_blocks), dim3(num_threads ), 0, 0, drowind, dval, m, nnz, dgraphindegree);
    ...
    magma_queue_t           queue )
{
    ...
    hipMemset(dx, 0, sizeof(magmaFloatComplex) * m * rhs);
    ...
    hipLaunchKernelGGL(sptrsm_syncfree_executor, dim3(num_blocks), dim3(num_threads ), 0, 0, dcolptr, drowind, dval, dgraphindegree,
