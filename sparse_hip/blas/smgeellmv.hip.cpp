...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zmgeellmv.hip.cpp, normal z -> s, Mon Oct 28 11:13:00 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(smgeellmv_kernel, dim3(grid), dim3(threads), MEM_SIZE, queue->hip_stream() ,  m, n, num_vecs, nnz_per_row, alpha, dval, dcolind, dx, beta, dy );
