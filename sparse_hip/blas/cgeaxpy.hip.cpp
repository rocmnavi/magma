...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgeaxpy.hip.cpp, normal z -> c, Thu Jan 25 22:58:29 2024
    ...
    magma_queue_t queue )
{
    ...
    if( X.storage_type == Magma_DENSE && Y->storage_type == Magma_DENSE ){
        ...
        hipLaunchKernelGGL(cgeaxpy_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, X.dval, beta, Y->dval );
