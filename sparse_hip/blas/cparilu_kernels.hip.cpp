...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zparilu_kernels.hip.cpp, normal z -> c, Mon Jul 15 16:58:11 2024
    ...
    magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(magma_cparilu_csr_kernel, dim3(grid), dim3(block), 0, queue->hip_stream() , A.num_rows, A.nnz, A.rowidx, A.col, A.val, 
         L.row, L.col, L.val, 
         U.row, U.col, U.val);
