...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgesellcmv.hip.cpp, normal z -> c, Thu Jan 25 22:58:29 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cgesellcmv_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, blocksize, alpha,
