...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/zgedensereimsplit.hip.cpp, normal z -> s, Mon Oct 28 11:13:03 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sgedensereimsplit_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, A.row, A.dval, ReA->dval, ImA->dval );
