...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zmgecsrmv.hip.cpp, normal z -> c, Fri Aug 25 13:17:50 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cmgecsrmv_kernel, dim3(grid), dim3(threads), MEM_SIZE, queue->hip_stream(), m, n, num_vecs, alpha, dval, drowptr, dcolind, dx, beta, dy);
