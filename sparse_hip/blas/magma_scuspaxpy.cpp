/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zcuspaxpy.cpp, normal z -> s, Mon Jul 15 16:58:11 2024
       @author Hartwig Anzt
...
#define hipsparseXcsrgeamNnz(handle, m, n, descrA, nnzA, drowA, dcolA,                           \
    ...
    {                                                                                           \
        size_t bufsize;                                                                         \
        void *buf;                                                                              \
        float alpha = MAGMA_S_ONE, beta = MAGMA_S_ZERO;                               \
...
#if CUDA_VERSION >= 11000
#define hipsparseScsrgeam(handle, m, n, alpha, descrA, nnzA, dvalA, drowA, dcolA, beta,          \
                         descrB, nnzB, dvalB, drowB, dcolB, descrC, dvalC, drowC, dcolC )       \
    {                                                                                           \
        void *buf;                                                                              \
        printf("hipsparseScsrgeam bufsize = %d\n", 0);\
        hipsparseScsrgeam2(handle, m, n, alpha,                                                  \
    ...
    magma_queue_t queue )
{
             ...
             B.storage_type == Magma_CSRCOO ) )
    {
        ...
        hipsparseScsrgeam( handle, A.num_rows, A.num_cols,
                          (const float*)alpha,
                          descrA, A.nnz,
