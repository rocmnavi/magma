...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zsampleselect.hip.cpp, normal z -> d, Mon Oct 28 11:13:02 2024
*/
...
static __global__ void compute_abs(const double* __restrict__ in, double* __restrict__ out, int32_t size) 
{
...
{    
    ...
    if( arch >= 300 ) {
        ...
        hipLaunchKernelGGL(sampleselect, dim3(1), dim3(1), 0, queue->hip_stream(), gputmp1, gputmp2, gputree, gpuints, total_size, subset_size, gpuresult);
