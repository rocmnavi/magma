/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/blas/magma_zcuspmm.cpp, normal z -> d, Thu Jan 25 22:58:34 2024
       @author Hartwig Anzt
...
#define hipsparseDcsrgemm(handle, transA, transB, m, n, k, descrA, nnzA, dvalA, drowA, dcolA,    \
    ...
    {                                                                                           \
        ...
        void *buf;                                                                              \
        csrgemm2Info_t linfo = NULL;                                                            \
        printf("hipsparseDcsrgemm bufsize = %d\n", -1);                                          \
