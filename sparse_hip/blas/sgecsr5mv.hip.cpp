...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zgecsr5mv.hip.cpp, normal z -> s, Fri Aug 25 13:17:45 2023
       @author Weifeng Liu
    ...
    magma_queue_t           queue )
{
    ...
    if ( arch >= 600 ) {
        ...
        //sgecsrmv_kernel<<< grid, threads, 0, queue->hip_stream() >>>
        ...
        hipLaunchKernelGGL(sgecsr5mv_kernel_update_y, dim3(num_blocks), dim3(num_threads), 0, queue->hip_stream() , m, beta, dy);
