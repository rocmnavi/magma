...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/blas/zgedensereimsplit.hip.cpp, normal z -> d, Fri Aug 25 13:17:54 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dgedensereimsplit_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, A.row, A.dval, ReA->dval, ImA->dval );
