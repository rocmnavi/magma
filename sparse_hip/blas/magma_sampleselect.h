...
/* No-DP versions */
void sampleselect_nodp(hipStream_t stream, float*,float*,float*,int32_t*,int32_t,int32_t,float*);
void sampleselect_nodp(hipStream_t stream, double*,double*,double*,int32_t*,int32_t,int32_t,double*);
void sampleselect_tailcall_nodp(hipStream_t stream, float*,float*,float*,int32_t*,float*);
void sampleselect_tailcall_nodp(hipStream_t stream, double*,double*,double*,int32_t*,double*);
