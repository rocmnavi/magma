/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/testing/testing_zspmm.cpp, normal z -> c, Fri Aug 25 13:18:21 2023
       @author Hartwig Anzt
*/
    ...
    while( i < argc ) {
        ...
        for (j=0; j < 10; j++) {
            hipsparseCcsrmm(hipsparseHandle,
                           ...
                           (hipblasComplex*)&alpha, descr, (hipblasComplex*)dA.dval, dA.drow, dA.dcol,
                           (hipblasComplex*)dx.dval, dA.num_cols, (hipblasComplex*)&beta, 
                           (hipblasComplex*)dy.dval, dA.num_cols);
        }
        end = magma_sync_wtime( queue );
