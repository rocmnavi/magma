/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse_hip/testing/testing_zgetrowptr.cpp, normal z -> s, Fri Aug 25 13:18:19 2023
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
   ...
   */ 
    ...
    TESTING_CHECK(magma_sget_row_ptr(num_rows,&nnz,d_rowidx,d_rowptr,queue));
