/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/testing/testing_zsolver_rhs.cpp, normal z -> c, Mon Jul 15 16:58:28 2024
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        magma_cmconvert(x_h, &b_h, Magma_DENSE, Magma_CSR, queue );
        // write to file
        TESTING_CHECK( magma_cwrite_csrtomtx( b_h, filename, queue ));
