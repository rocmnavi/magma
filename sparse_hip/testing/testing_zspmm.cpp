    ...
    while( i < argc ) {
        ...
        for (j=0; j < 10; j++) {
            hipsparseZcsrmm(hipsparseHandle,
                           ...
                           (hipblasDoubleComplex*)&alpha, descr, (hipblasDoubleComplex*)dA.dval, dA.drow, dA.dcol,
                           (hipblasDoubleComplex*)dx.dval, dA.num_cols, (hipblasDoubleComplex*)&beta, 
                           (hipblasDoubleComplex*)dy.dval, dA.num_cols);
        }
        end = magma_sync_wtime( queue );
