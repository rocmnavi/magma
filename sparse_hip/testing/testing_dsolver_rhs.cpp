/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/testing/testing_zsolver_rhs.cpp, normal z -> d, Mon Jul 15 16:58:28 2024
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        magma_dmconvert(x_h, &b_h, Magma_DENSE, Magma_CSR, queue );
        // write to file
        TESTING_CHECK( magma_dwrite_csrtomtx( b_h, filename, queue ));
