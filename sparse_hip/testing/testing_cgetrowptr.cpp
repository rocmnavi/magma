/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/testing/testing_zgetrowptr.cpp, normal z -> c, Mon Oct 28 11:13:20 2024
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
   ...
   */ 
    ...
    TESTING_CHECK(magma_cget_row_ptr(num_rows,&nnz,d_rowidx,d_rowptr,queue));
