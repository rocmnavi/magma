/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/testing/testing_zspmm.cpp, normal z -> s, Mon Jul 15 16:58:27 2024
       @author Hartwig Anzt
*/
    ...
    while( i < argc ) {
        ...
        for (j=0; j < 10; j++) {
            hipsparseScsrmm(hipsparseHandle,
                           ...
                           (float*)&alpha, descr, (float*)dA.dval, dA.drow, dA.dcol,
                           (float*)dx.dval, dA.num_cols, (float*)&beta, 
                           (float*)dy.dval, dA.num_cols);
        }
        end = magma_sync_wtime( queue );
