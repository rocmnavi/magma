/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/control/magma_zmtranspose.cpp, normal z -> c, Mon Oct 28 11:13:08 2024
       @author Hartwig Anzt
       @author Mark Gates
...
#define hipsparseCcsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, colB, rowB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
    ...
    magma_queue_t queue )
{
    ...
    if( A.storage_type == Magma_CSR && A.memory_location == Magma_DEV ) {
        ...
        hipsparseCcsr2csc( handle, A.num_rows, A.num_cols, A.nnz,
                          (hipblasComplex*)A.dval, A.drow, A.dcol, (hipblasComplex*)B->dval, B->dcol, B->drow,
