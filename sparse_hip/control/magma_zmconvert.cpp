...
#define hipsparseZcsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, rowB, colB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
    ...
    magma_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_CPU )
    {
        ...
        if ( old_format == Magma_CSR && new_format == Magma_DENSE ) {
            ...
            //hipsparseZcsr2dense( cusparseHandle, A.num_rows, A.num_cols,
        ...
        // DENSE to CSR
            ...
            // hipsparseZnnz( cusparseHandle, HIPSPARSE_DIRECTION_COLUMN,
            ...
            // 
            // // conversion using CUSPARSE
            // hipsparseZdense2csr( cusparseHandle, A.num_rows, A.num_cols,
            //                     descr,
        ...
        // CSR to BCSR
            ...
            // conversion using CUSPARSE
            hipsparseZcsr2bsr( cusparseHandle, HIPSPARSE_DIRECTION_ROW,
                              A.num_rows, A.num_cols, descr,
                              (hipblasDoubleComplex*)A.dval, A.drow, A.dcol,
                              size_b, descr,
                              (hipblasDoubleComplex*)B->dval, B->drow, B->dcol);
        }
        // BCSR to CSR
            ...
            // conversion using CUSPARSE
            hipsparseZbsr2csr( cusparseHandle, HIPSPARSE_DIRECTION_ROW,
                              mb, nb, descr, (hipblasDoubleComplex*)A.dval, A.drow, A.dcol,
                              size_b, descr,
                              (hipblasDoubleComplex*)B->dval, B->drow, B->dcol );
        }
        // CSR to CSC
            ...
            // conversion using CUSPARSE
            hipsparseZcsr2csc(cusparseHandle, A.num_rows, A.num_cols, A.nnz,
                             (hipblasDoubleComplex*)A.dval, A.drow, A.dcol,
                             (hipblasDoubleComplex*)B->dval, B->drow, B->dcol,
        ...
        // CSC to CSR
            ...
            // conversion using CUSPARSE
            hipsparseZcsr2csc(cusparseHandle, A.num_cols, A.num_rows, A.nnz,
                             (hipblasDoubleComplex*)A.dval, A.dcol, A.drow,
                             (hipblasDoubleComplex*)B->dval, B->dcol, B->drow,
                             HIPSPARSE_ACTION_NUMERIC,
                             HIPSPARSE_INDEX_BASE_ZERO);
        }
        // CSR to COO
...
#else
            hipsparseZgthr(cusparseHandle, nnz, A.dval, B->dval, P, HIPSPARSE_INDEX_BASE_ZERO);
#endif
