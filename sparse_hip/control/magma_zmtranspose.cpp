...
#define hipsparseZcsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, colB, rowB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
    ...
    magma_queue_t queue )
{
    ...
    if( A.storage_type == Magma_CSR && A.memory_location == Magma_DEV ) {
        ...
        hipsparseZcsr2csc( handle, A.num_rows, A.num_cols, A.nnz,
                          (hipblasDoubleComplex*)A.dval, A.drow, A.dcol, (hipblasDoubleComplex*)B->dval, B->dcol, B->drow,
