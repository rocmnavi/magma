/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/control/magma_zmtranspose.cpp, normal z -> d, Mon Jul 15 16:58:16 2024
       @author Hartwig Anzt
       @author Mark Gates
...
#define hipsparseDcsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, colB, rowB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
    ...
    magma_queue_t queue )
{
    ...
    if( A.storage_type == Magma_CSR && A.memory_location == Magma_DEV ) {
        ...
        hipsparseDcsr2csc( handle, A.num_rows, A.num_cols, A.nnz,
                          (double*)A.dval, A.drow, A.dcol, (double*)B->dval, B->dcol, B->drow,
