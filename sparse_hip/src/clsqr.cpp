/*
    -- MAGMA (version 2.0) --
       ...
       @generated from sparse_hip/src/zlsqr.cpp, normal z -> c, Mon Jul 15 16:58:24 2024
*/
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_cmtransfer( A, &Ah1, Magma_DEV, Magma_CPU, queue ) );
    CHECK( magma_cmconvert( Ah1, &Ah2, A.storage_type, Magma_CSR, queue ) );
    magma_cmfree(&Ah1, queue );
    CHECK( magma_cmtransposeconjugate( Ah2, &Ah1, queue ) );
    magma_cmfree(&Ah2, queue );
    Ah2.blocksize = A.blocksize;
    Ah2.alignment = A.alignment;
    CHECK( magma_cmconvert( Ah1, &Ah2, Magma_CSR, A.storage_type, queue ) );
    magma_cmfree(&Ah1, queue );
    CHECK( magma_cmtransfer( Ah2, &AT, Magma_CPU, Magma_DEV, queue ) );
    magma_cmfree(&Ah2, queue );
