/*
    -- MAGMA (version 2.0) --
       ...
       @generated from testing/testing_ztrsm.cpp, normal z -> d, Mon Jul 15 16:57:53 2024
...
int main( int argc, char** argv)
{
    ...
    double alpha = MAGMA_D_ONE; //MAGMA_D_MAKE(  0.29, -0.86 );
    int status = 0;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lapackf77_dlacpy( MagmaFullStr, &M, &N, hB, &ldb, hBlapack, &ldb );
            lapackf77_dlacpy( MagmaFullStr, &M, &N, hB, &ldb, hBmagma,  &ldb );
            ...
            normA = lapackf77_dlantr( "I",
                ...
                normR = lapackf77_dlange( "I", &M, &N, hX,      &ldb, work );
                normX = lapackf77_dlange( "I", &M, &N, hBmagma, &ldb, work );
            ...
            blasf77_daxpy( &sizeB, &c_neg_one, hB, &ione, hX, &ione );
            normR = lapackf77_dlange( "I", &M, &N, hX,    &ldb, work );
            normX = lapackf77_dlange( "I", &M, &N, hBdev, &ldb, work );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_daxpy( &sizeB, &c_neg_one, hB, &ione, hX, &ione );
                normR = lapackf77_dlange( "I", &M, &N, hX,       &ldb, work );
                normX = lapackf77_dlange( "I", &M, &N, hBlapack, &ldb, work );
