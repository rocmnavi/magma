/*
    -- MAGMA (version 2.0) --
       ...
       @generated from testing/testing_ztrsm.cpp, normal z -> s, Mon Oct 28 11:12:28 2024
...
int main( int argc, char** argv)
{
    ...
    float alpha = MAGMA_S_ONE; //MAGMA_S_MAKE(  0.29, -0.86 );
    int status = 0;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lapackf77_slacpy( MagmaFullStr, &M, &N, hB, &ldb, hBlapack, &ldb );
            lapackf77_slacpy( MagmaFullStr, &M, &N, hB, &ldb, hBmagma,  &ldb );
            ...
            normA = lapackf77_slantr( "I",
                ...
                normR = lapackf77_slange( "I", &M, &N, hX,      &ldb, work );
                normX = lapackf77_slange( "I", &M, &N, hBmagma, &ldb, work );
            ...
            blasf77_saxpy( &sizeB, &c_neg_one, hB, &ione, hX, &ione );
            normR = lapackf77_slange( "I", &M, &N, hX,    &ldb, work );
            normX = lapackf77_slange( "I", &M, &N, hBdev, &ldb, work );
            ...
            if ( opts.lapack ) {
                ...
                blasf77_saxpy( &sizeB, &c_neg_one, hB, &ione, hX, &ione );
                normR = lapackf77_slange( "I", &M, &N, hX,       &ldb, work );
                normX = lapackf77_slange( "I", &M, &N, hBlapack, &ldb, work );
