/*
    -- MAGMA (version 2.0) --
       ...
       @generated from testing/testing_zlaset.cpp, normal z -> c, Mon Jul 15 16:57:55 2024
       @author Mark Gates
*/
      ...
      for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
          for( int ival = 0; ival < 4; ++ival ) {
            ...
            // 2     1.23     0
            // 3     1.23     3.14
            offdiag = MAGMA_C_MAKE( 1.2345, 6.7890 ) * (float)(ival / 2);
            diag    = MAGMA_C_MAKE( 3.1415, 2.7183 ) * (float)(ival % 2);
