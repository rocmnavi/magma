/*
    -- MAGMA (version 2.0) --
       ...
       @generated from testing/testing_zcgesv_gpu.cpp, mixed zc -> ds, Mon Jul 15 16:57:57 2024
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dgetmatrix( N, nrhs, d_B, lddb, h_B, ldb, opts.queue );
            ...
            // Compute error
            magma_dgetmatrix( N, nrhs, d_B, lddb, h_X, ldx, opts.queue );
            blasf77_dgemm( lapack_trans_const(opts.transA), MagmaNoTransStr,
                           &N, &nrhs, &N,
                           &c_one,     h_A, &lda,
                                       h_X, &ldx,
