/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/testing/testing_zspmm.cpp, normal z -> c, Fri Aug 25 13:19:34 2023
       @author Hartwig Anzt
*/
    ...
    while( i < argc ) {
        ...
        for (j=0; j < 10; j++) {
            cusparseCcsrmm(cusparseHandle,
                           ...
                           (cuFloatComplex*)&alpha, descr, (cuFloatComplex*)dA.dval, dA.drow, dA.dcol,
                           (cuFloatComplex*)dx.dval, dA.num_cols, (cuFloatComplex*)&beta, 
                           (cuFloatComplex*)dy.dval, dA.num_cols);
        }
        end = magma_sync_wtime( queue );
