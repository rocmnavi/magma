/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_zcuspaxpy.cpp, normal z -> s, Fri Aug 25 13:19:05 2023
       @author Hartwig Anzt
...
#if CUDA_VERSION >= 11000
#define cusparseScsrgeam(handle, m, n, alpha, descrA, nnzA, dvalA, drowA, dcolA, beta,          \
                         descrB, nnzB, dvalB, drowB, dcolB, descrC, dvalC, drowC, dcolC )       \
    {                                                                                           \
        void *buf;                                                                              \
        printf("cusparseScsrgeam bufsize = %d\n", 0);\
        cusparseScsrgeam2(handle, m, n, alpha,                                                  \
