/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_zmatrixtools_gpu.cu, normal z -> d, Fri Aug 25 13:19:09 2023
...
#else
    cusparseDgthr(handle, A->nnz, (double*)A->dval, (double*)csrVal_sorted, P, 
        CUSPARSE_INDEX_BASE_ZERO);
#endif
