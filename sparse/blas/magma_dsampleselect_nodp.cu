/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_zsampleselect_nodp.cu, normal z -> d, Fri Aug 25 13:19:07 2023
*/
...
{    
    ...
    //if( arch >= 350 ) {
        ...
        sampleselect_nodp(queue->cuda_stream(), gputmp1, gputmp2, gputree, gpuints, total_size, subset_size, gpuresult);
