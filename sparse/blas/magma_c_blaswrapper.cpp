/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_z_blaswrapper.cpp, normal z -> c, Fri Aug 25 13:18:58 2023
       @author Hartwig Anzt
...
#else
#define cusparseCcsrmv(handle, op, rows, cols, nnz, alpha, descr, dval, drow, dcol, x, beta, y) \
    CHECK_CUSPARSE(cusparseCcsrmv(handle,op,rows,cols,nnz,alpha,descr,dval,drow,dcol,x,beta,y))
#endif
        ...
        if ( A.num_cols == x.num_rows && x.num_cols == 1 ) {
                 ...
                 A.storage_type == Magma_CSRU )
            {
                ...
                cusparseCcsrmv( cusparseHandle,CUSPARSE_OPERATION_NON_TRANSPOSE,
                                A.num_rows, A.num_cols, A.nnz, (cuFloatComplex*)&alpha, descr,
                                (cuFloatComplex*)A.dval, A.drow, A.dcol, (cuFloatComplex*)x.dval, (cuFloatComplex*)&beta, (cuFloatComplex*)y.dval );
            }
            else if ( A.storage_type == Magma_CSC )
            {
               ...
               cusparseCbsrmv( cusparseHandle, dirA,
                   ...
                   (cuFloatComplex*)&alpha, descr, (cuFloatComplex*)A.dval, A.drow, A.dcol, A.blocksize, (cuFloatComplex*)x.dval,
                   (cuFloatComplex*)&beta, (cuFloatComplex*)y.dval );
            }
            else {
            ...
            if ( A.storage_type == Magma_CSR ) {
                ...
                if ( x.major == MagmaColMajor) {
                    cusparseCcsrmm(cusparseHandle,
                                   ...
                                   (cuFloatComplex*)&alpha, descr, (cuFloatComplex*)A.dval, A.drow, A.dcol,
                                   (cuFloatComplex*)x.dval, A.num_cols, (cuFloatComplex*)&beta, (cuFloatComplex*)y.dval, A.num_cols);
