/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_zmatrixtools_gpu.cu, normal z -> c, Fri Aug 25 13:19:09 2023
...
{   
    ...
    CHECK_CUSPARSE( cusparseCreateDnVec(&vec_values, A->nnz, A->dval, CUDA_C_32F) );
...
#else
    cusparseCgthr(handle, A->nnz, (cuFloatComplex*)A->dval, (cuFloatComplex*)csrVal_sorted, P, 
        CUSPARSE_INDEX_BASE_ZERO);
#endif
