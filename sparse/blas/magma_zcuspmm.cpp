...
#define cusparseXcsrgemmNnz(handle, transA, transB, m, n, k, descrA, nnzA, drowA, dcolA,        \
    ...
    {                                                                                           \
        ...
        cusparseZcsrgemm2_bufferSizeExt(handle, m, n, k, &alpha,                                \
...
#define cusparseZcsrgemm(handle, transA, transB, m, n, k, descrA, nnzA, dvalA, drowA, dcolA,    \
    ...
    {                                                                                           \
        cusparseMatDescr_t descrD;                                                              \
        int nnzD, *drowD, *dcolD;                                                               \
        cuDoubleComplex *dvalD, alpha = MAGMA_Z_ONE, *beta = NULL;                              \
        void *buf;                                                                              \
        csrgemm2Info_t linfo = NULL;                                                            \
        printf("cusparseZcsrgemm bufsize = %d\n", -1);                                          \
        cusparseZcsrgemm2(handle, m, n, k, &alpha,                                              \
