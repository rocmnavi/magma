/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_ztrisolve.cpp, normal z -> s, Fri Aug 25 13:19:05 2023
*/
...
cleanup:
    ...
    CHECK_CUSPARSE(cusparseSetMatFillMode(descr, fill_mode));
    {
        ...
        CHECK_CUSPARSE(cusparseScsrsm2_bufferSizeExt(cusparseHandle, algo, M_op, op,
        ...
        if (buffer_size > 0)
            magma_malloc(&solve_info->buffer, buffer_size);
        CHECK_CUSPARSE(cusparseScsrsm2_analysis(cusparseHandle, algo, M_op, op,
...
cleanup:
    ...
    CHECK_CUSPARSE(cusparseSetMatFillMode(descr, fill_mode));
    {
        ...
        CHECK_CUSPARSE(cusparseScsrsm2_solve(cusparseHandle, algo, M_op, op,
