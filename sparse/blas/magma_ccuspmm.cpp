/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/blas/magma_zcuspmm.cpp, normal z -> c, Fri Aug 25 13:19:05 2023
       @author Hartwig Anzt
...
cleanup:
             ...
             B.storage_type == Magma_CSRCOO ) )
    {
        ...
        CHECK_CUSPARSE( cusparseSpGEMM_workEstimation(handle, opA, opB,
                                                      ...
                                                      CUDA_C_32F, CUSPARSE_SPGEMM_DEFAULT,
        ...
        CHECK_CUSPARSE( cusparseSpGEMM_copy(handle, opA, opB,
                                            &alpha, descrA, descrB, beta, descrC,
                                            CUDA_C_32F, CUSPARSE_SPGEMM_DEFAULT, spgemmDesc) );
