/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/control/magma_zmconvert.cpp, normal z -> d, Fri Aug 25 13:19:11 2023
       @author Hartwig Anzt
*/
    ...
    magma_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_CPU )
    {
        ...
        // COO to CSR
            ...
            CHECK_CUSPARSE( cusparseCreateDnVec(&vec_values, A.nnz, A.dval, CUDA_R_64F) );
