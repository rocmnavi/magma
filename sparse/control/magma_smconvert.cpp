/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/control/magma_zmconvert.cpp, normal z -> s, Fri Aug 25 13:19:11 2023
       @author Hartwig Anzt
*/
...
#define cusparseScsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, rowB, colB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
        cusparseCsr2cscEx2_bufferSize(handle, m, n, nnz, valA, rowA, colA,                     \
                                      valB, rowB, colB, CUDA_R_32F, action, base,              \
    ...
    magma_queue_t queue )
{
    ...
    if ( A.memory_location == Magma_CPU )
    {
        ...
        // COO to CSR
            ...
            CHECK_CUSPARSE( cusparseCreateDnVec(&vec_values, A.nnz, A.dval, CUDA_R_32F) );
