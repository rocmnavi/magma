/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from sparse/control/magma_zmtranspose.cpp, normal z -> s, Fri Aug 25 13:19:14 2023
       @author Hartwig Anzt
       @author Mark Gates
...
#define cusparseScsr2csc(handle, m, n, nnz, valA, rowA, colA, valB, colB, rowB,                \
                         action, base)                                                         \
    {                                                                                          \
        size_t bufsize;                                                                        \
        void *buf;                                                                             \
        cusparseCsr2cscEx2_bufferSize(handle, m, n, nnz, valA, rowA, colA,                     \
                                      valB, colB, rowB, CUDA_R_32F, action, base,              \
