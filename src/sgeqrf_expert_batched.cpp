/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from src/zgeqrf_expert_batched.cpp, normal z -> s, Fri Aug 25 13:16:48 2023
*/
...
/***************************************************************************//**
    ...
    dW_array Array of pointers, dimension (2*batchCount).
             Each is a REAL array on the GPU, dimension (LDDW, N),
    ...
    magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magmablas_slaset_internal_batched(
            MagmaFull, lddr, (provide_RT > 0 ? n:min(min_mn,nb)), MAGMA_S_ZERO, MAGMA_S_ZERO,
            dR_array, 0, 0, lddr, batchCount, queue );
    magmablas_slaset_internal_batched(
            MagmaFull, lddt, (provide_RT > 0 ? n:min(min_mn,nb)), MAGMA_S_ZERO, MAGMA_S_ZERO,
            dT_array, 0, 0, lddt, batchCount, queue );
    magmablas_slaset_internal_batched(
            MagmaFull, lddw, n, MAGMA_S_ZERO, MAGMA_S_ZERO,
    ...
    for (i=0; i < min_mn; i += nb) {
        ...
        magma_sgeqrf_panel_internal_batched(m-i, ib, jb,
                                   dA_array,   i, i, ldda,
                                   dtau_array, i,
        ...
        if ( (n-ib-i) > 0) {
            ...
            magma_slarfb_gemm_internal_batched(
                            ...
                            m-i, n-i-ib, ib,
                            (const float**)dA_array,   i,   i, ldda,
                            (const float**)dT_array, Tii, Tjj, lddt,
