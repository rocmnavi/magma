/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zgeqrf_expert_batched.cpp, normal z -> d, Mon Oct 28 11:12:01 2024
*/
...
/***************************************************************************//**
    ...
    dW_array Array of pointers, dimension (2*batchCount).
             Each is a DOUBLE PRECISION array on the GPU, dimension (LDDW, N),
    ...
    magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magmablas_dlaset_internal_batched(
            MagmaFull, lddr, (provide_RT > 0 ? n:min(min_mn,nb)), MAGMA_D_ZERO, MAGMA_D_ZERO,
            dR_array, 0, 0, lddr, batchCount, queue );
    magmablas_dlaset_internal_batched(
            MagmaFull, lddt, (provide_RT > 0 ? n:min(min_mn,nb)), MAGMA_D_ZERO, MAGMA_D_ZERO,
            dT_array, 0, 0, lddt, batchCount, queue );
    magmablas_dlaset_internal_batched(
            MagmaFull, lddw, n, MAGMA_D_ZERO, MAGMA_D_ZERO,
    ...
    for (i=0; i < min_mn; i += nb) {
        ...
        magma_dgeqrf_panel_internal_batched(m-i, ib, jb,
                                   dA_array,   i, i, ldda,
                                   dtau_array, i,
        ...
        if ( (n-ib-i) > 0) {
            ...
            magma_dlarfb_gemm_internal_batched(
                            ...
                            m-i, n-i-ib, ib,
                            (const double**)dA_array,   i,   i, ldda,
                            (const double**)dT_array, Tii, Tjj, lddt,
