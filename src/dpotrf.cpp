/*
    -- MAGMA (version 2.0) --
       ...
       @author Stan Tomov
       @generated from src/zpotrf.cpp, normal z -> d, Mon Oct 28 11:11:33 2024
*/
...
/******************************************************************************
    magma_dpotrf_expert with two queues.
    @see magma_dpotrf_expert
    @ingroup magma_potrf
*******************************************************************************/
extern "C" magma_int_t
magma_dpotrf(
    ...
    magma_int_t *info )
{
    ...
    if ( 2*nb < n && ngpu <= 1) {
        ...
        magma_dpotrf_expert(uplo, n, A, lda, dA, ldda, info, queues );
        ...
        return magma_dpotrf_expert( uplo, n, A, lda, dA, ldda, info, queues );
    }
    return *info;
} /* magma_dpotrf */
