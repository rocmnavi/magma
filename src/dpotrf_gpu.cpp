/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zpotrf_gpu.cpp, normal z -> d, Mon Jul 15 16:57:15 2024
*/
...
/***************************************************************************//**
    ...
    nb      INTEGER
            ...
            Users with no specific preference of nb can call magma_get_dpotrf_nb()
    ...
    magma_event_t events[2], magma_queue_t queues[2] )
{
    ...
    *info = 0;
    ...
    if (mode == MagmaHybrid) {
        if ( nb <= 1 || 4*nb >= n ) {
            h_workspace_bytes += n * n * sizeof(double);
        }
        else {
            h_workspace_bytes += nb * nb * sizeof(double);
        }
    }
    else {
...
/***************************************************************************//**
    wrapper around magma_dpotrf_expert_gpu_work to hide workspace, event,
    and queue management
    @see magma_dpotrf_expert_gpu_work
    @ingroup magma_potrf
*******************************************************************************/
extern "C" magma_int_t
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    magma_int_t nb = magma_get_dpotrf_nb( n );
