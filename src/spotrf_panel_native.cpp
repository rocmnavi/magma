/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zpotrf_panel_native.cpp, normal z -> s, Mon Oct 28 11:12:02 2024
*/
    ...
    magma_int_t *dinfo,  magma_int_t *info, magma_queue_t queue)
{
    ...
    *info = 0;
    ...
    if (n <= recnb) {
        //  panel factorization
        if(uplo == MagmaLower) {
            magma_spotf2_lpin(uplo, n, dA, ldda, gbstep, dinfo, queue );
        }
        else {
            magma_spotf2_native(uplo, n, dA, ldda, gbstep, dinfo, queue );
        }
    }
    else {
