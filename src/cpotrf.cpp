/*
    -- MAGMA (version 2.0) --
       ...
       @author Stan Tomov
       @generated from src/zpotrf.cpp, normal z -> c, Thu Jan 25 23:02:40 2024
*/
...
/******************************************************************************
    magma_cpotrf_expert with two queues.
    @see magma_cpotrf_expert
    @ingroup magma_potrf
*******************************************************************************/
extern "C" magma_int_t
magma_cpotrf(
    ...
    magma_int_t *info )
{
    ...
    if ( 2*nb < n && ngpu <= 1) {
        ...
        magma_cpotrf_expert(uplo, n, A, lda, dA, ldda, info, queues );
        ...
        return magma_cpotrf_expert( uplo, n, A, lda, dA, ldda, info, queues );
    }
    return *info;
} /* magma_cpotrf */
