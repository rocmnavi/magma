/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zhetrf.cpp, normal z -> s, Mon Oct 28 11:11:46 2024
*/
    ...
    if ( upper ) {
        ...
        for (k = n-1; k >= 0; k -= kb ) {
            ...
            if ( k+1 > nb ) {
                ...
                magma_sgetmatrix_async( nk, kb, dA(0,nk-kb), ldda, A(0,nk-kb), lda, queues[1] );  
                trace_gpu_end( 0, 1 );
            } else {
        ...
        for (k = 0; k < n; k += kb ) {
            ...
            if ( k < n-nb ) {
                ...
                magma_queue_wait_event( queues[1], event );
                trace_gpu_start( 0, 1, "get", "get" );
                magma_sgetmatrix_async( nk, kb, dA(k,k), ldda, A(k,k), lda, queues[1] );
                trace_gpu_end( 0, 1 ); 
            }
            else {
