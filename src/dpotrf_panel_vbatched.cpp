/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zpotrf_panel_vbatched.cpp, normal z -> d, Mon Jul 15 16:57:36 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if ((max_n-nb) > 0) {
        ...
        magmablas_dtrsm_inv_work_vbatched( MagmaRight, MagmaLower, MagmaConjTrans, MagmaNonUnit, 1,
                                           n_minus_ib, ibvec,
                                           MAGMA_D_ONE,
                                           dA_array,  ldda,
                                           dW0_displ, ldda,
