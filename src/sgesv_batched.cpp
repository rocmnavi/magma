/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zgesv_batched.cpp, normal z -> s, Thu Jan 25 23:02:59 2024
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    info = magma_sgesv_batched_small(n, nrhs, dA_array, ldda, dipiv_array, dB_array, lddb, dinfo_array, batchCount, queue);
    if( info == 0 ) {
        return info;
    }
