/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zhetrf_gpu.cpp, normal z -> c, Mon Jul 15 16:57:24 2024
*/
    ...
    magma_int_t *ipiv, magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magmaFloatComplex_ptr A, dW;
    if ((MAGMA_SUCCESS != magma_cmalloc_pinned( &A, nb*lda  )) ||
    ...
    if ( upper ) {
        ...
        for (k = n-1; k >= 0; k -= kb ) {
            ...
            if ( k+1 > nb ) {
                ...
                magma_csetmatrix( nk, nk, A( 0, 0 ), lda, dA( 0, 0 ), ldda, queues[0] );
                kb = k+1;
            }
        ...
        for (k = 0; k < n; k += kb ) {
            ...
            if ( k < n-nb ) {
                ...
                magma_csetmatrix( nk, nk, A(k,k), lda, dA(k,k), ldda, queues[0] );
            }
            /* Set INFO on the first occurrence of a zero pivot */
