/*
   ...
   @generated from src/zgetrf_panel_native.cpp, normal z -> d, Thu Jan 25 23:03:02 2024
*/
    ...
    magma_event_t events[2], magma_queue_t queue, magma_queue_t update_queue)
{
    ...
    if (panel_nb <= recnb) {
        magma_dgetf2_native(m, n, dA, ldda, dipiv, dipivinfo, dinfo, gbstep, events, queue, update_queue);
        return 0;
    }
    else {
        ...
        // panel on A1
        magma_dgetrf_recpanel_native(m, n1, recnb, dA(0,0), ldda, dipiv, dipivinfo, dinfo, gbstep, events, queue, update_queue);
        ...
        // panel on A2
        magma_dgetrf_recpanel_native(m-n1, n2, recnb, dA(n1,n1), ldda, dipiv+n1, dipivinfo+n1, dinfo, gbstep+n1, events, queue, update_queue);
