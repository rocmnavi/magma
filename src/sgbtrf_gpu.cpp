/*
   ...
   @generated from src/zgbtrf_gpu.cpp, normal z -> s, Mon Oct 28 11:11:37 2024
*/

#include "magma_internal.h"
#include "batched_kernel_param.h"

#define MAGMA_SGBTRF_NATIVE_DISABLE_COOP_KERNEL
        ...
        magma_queue_t queue)
{
    ...
    #ifndef MAGMA_SGBTRF_NATIVE_DISABLE_COOP_KERNEL
    ...
    magma_sgbtf2_native_v2_work(m, n, kl, ku, dAB, lddab, dipiv, info, device_work, gbtrf_cogroups_lwork, queue);
...
magma_sgbtrf_native(
        magma_int_t m, magma_int_t n,
        magma_int_t kl, magma_int_t ku,
        float* dAB, magma_int_t lddab, magma_int_t* dipiv,
        magma_int_t *info)
{
    magma_int_t kv    = kl + ku;
