/*
   ...
   @generated from src/zgetrf_panel_native.cpp, normal z -> c, Fri Aug 25 13:16:50 2023
*/
    ...
    magma_event_t events[2], magma_queue_t queue, magma_queue_t update_queue)
{
    ...
    if (panel_nb <= recnb) {
        magma_cgetf2_native(m, n, dA, ldda, dipiv, dipivinfo, dinfo, gbstep, events, queue, update_queue);
        return 0;
    }
    else {
        ...
        // panel on A1
        magma_cgetrf_recpanel_native(m, n1, recnb, dA(0,0), ldda, dipiv, dipivinfo, dinfo, gbstep, events, queue, update_queue);
        ...
        // panel on A2
        magma_cgetrf_recpanel_native(m-n1, n2, recnb, dA(n1,n1), ldda, dipiv+n1, dipivinfo+n1, dinfo, gbstep+n1, events, queue, update_queue);
