/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zgesv_rbt_batched.cpp, normal z -> s, Mon Oct 28 11:11:59 2024
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    info = magma_sgerbt_batched(MagmaTrue, n, nrhs, dA_array, ldda, dB_array, lddb, hu, hv, &info, batchCount, queue);
    ...
    magmablas_sprbt_mv_batched(n, nrhs, dv, dB_array, lddb, batchCount, queue);
