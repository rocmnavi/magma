/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from src/zgetrf_gpu.cpp, normal z -> s, Fri Aug 25 13:16:18 2023
    ...
    *info = 0;
    ...
    if (nb <= 1 || 4*nb >= min(m,n) )
        if (mode == MagmaHybrid) {
            ...
            magma_sgetmatrix( m, n, dA(0,0), ldda, work, m, NULL);
            lapackf77_sgetrf( &m, &n, work, &m, ipiv, info );
            magma_ssetmatrix( m, n, work, m, dA(0,0), ldda, NULL);
            magma_free_cpu( work );  work=NULL;
