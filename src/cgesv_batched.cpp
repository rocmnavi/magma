/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from src/zgesv_batched.cpp, normal z -> c, Fri Aug 25 13:16:45 2023
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    info = magma_cgesv_batched_small(n, nrhs, dA_array, ldda, dipiv_array, dB_array, lddb, dinfo_array, batchCount, queue);
    if( info == 0 ) {
        return info;
    }
