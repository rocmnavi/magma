/*
   ...
   @generated from src/zgbsv_batched.cpp, normal z -> s, Thu Jan 25 23:02:58 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    gbtrf_lwork = -1;
    magma_sgbtrf_batched_work( n, n, kl, ku, NULL, ldda, NULL, NULL, NULL, &gbtrf_lwork, batchCount, queue);
    ...
    magma_int_t ntcol = 1;
    magma_get_sgbtrf_batched_params(n, n, kl, ku, &nb, &nthreads);
    magma_int_t fused_info = -1;
    if( n <= 64 && nrhs == 1) {
        fused_info = magma_sgbsv_batched_fused_sm(
                n, kl, ku, nrhs,
...
////////////////////////////////////////////////////////////////////////////////
/// @see magma_sgbsv_batched_work.
/// This is the (pointer + stride) interface of magma_sgbsv_batched_work
extern "C" magma_int_t
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    float** dA_array   = (float**)queue->get_dAarray();
    float** dB_array   = (float**)queue->get_dBarray();
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
        ...
        magma_sset_pointer(dA_array,    (float*)(dA + i * strideA), ldda, 0, 0, strideA,   batch, queue);
        magma_sset_pointer(dB_array,    (float*)(dB + i * strideB), lddb, 0, 0, strideB,   batch, queue);
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magma_sgbsv_batched_work(n, kl, ku, nrhs, NULL, ldda, NULL, NULL, lddb, NULL, NULL, lwork, batchCount, queue);
...
////////////////////////////////////////////////////////////////////////////////
/// @see magma_sgbsv_batched.
/// This is the (pointer + stride) interface of magma_sgbsv_batched
extern "C"
magma_int_t
