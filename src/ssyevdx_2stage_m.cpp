/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zheevdx_2stage_m.cpp, normal z -> s, Mon Jul 15 16:57:28 2024
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( ( ntiles < 2 ) || ( n <= 128 ) ) {
        ...
        magma_smalloc_cpu(&Y, n*ldy);
        lapackf77_ssyevx(jobz_, range_, uplo_,
        ...
        if( wantz ) {
            lapackf77_slacpy(MagmaFullStr, &n, m, Y, &ldy, A, &lda);
        }
