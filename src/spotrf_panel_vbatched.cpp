/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zpotrf_panel_vbatched.cpp, normal z -> s, Mon Oct 28 11:12:01 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if ((max_n-nb) > 0) {
        ...
        magmablas_strsm_inv_work_vbatched( MagmaRight, MagmaLower, MagmaConjTrans, MagmaNonUnit, 1,
                                           n_minus_ib, ibvec,
                                           MAGMA_S_ONE,
                                           dA_array,  ldda,
                                           dW0_displ, ldda,
