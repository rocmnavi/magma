/*
   ...
   @generated from src/zgbsv_batched.cpp, normal z -> d, Mon Oct 28 11:11:58 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    gbtrf_lwork = -1;
    magma_dgbtrf_batched_work( n, n, kl, ku, NULL, ldda, NULL, NULL, NULL, &gbtrf_lwork, batchCount, queue);
    ...
    magma_int_t ntcol = 1;
    magma_get_dgbtrf_batched_params(n, n, kl, ku, &nb, &nthreads);
    magma_int_t fused_info = -1;
    if( n <= 64 && nrhs == 1) {
        fused_info = magma_dgbsv_batched_fused_sm(
                n, kl, ku, nrhs,
...
////////////////////////////////////////////////////////////////////////////////
/// @see magma_dgbsv_batched_work.
/// This is the (pointer + stride) interface of magma_dgbsv_batched_work
extern "C" magma_int_t
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    double** dA_array   = (double**)queue->get_dAarray();
    double** dB_array   = (double**)queue->get_dBarray();
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
        ...
        magma_dset_pointer(dA_array,    (double*)(dA + i * strideA), ldda, 0, 0, strideA,   batch, queue);
        magma_dset_pointer(dB_array,    (double*)(dB + i * strideB), lddb, 0, 0, strideB,   batch, queue);
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magma_dgbsv_batched_work(n, kl, ku, nrhs, NULL, ldda, NULL, NULL, lddb, NULL, NULL, lwork, batchCount, queue);
...
////////////////////////////////////////////////////////////////////////////////
/// @see magma_dgbsv_batched.
/// This is the (pointer + stride) interface of magma_dgbsv_batched
extern "C"
magma_int_t
