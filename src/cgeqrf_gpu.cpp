/*
    -- MAGMA (version 2.0) --
       ...
       @generated from src/zgeqrf_gpu.cpp, normal z -> c, Thu Jan 25 23:02:44 2024
*/
...
/***************************************************************************//**
    ...
    nb      INTEGER
            ...
            Users with no specific preference of nb can call magma_get_cgeqrf_nb()
...
magma_cgeqrf_expert_gpu_work(
    magma_int_t m, magma_int_t n,
    magmaFloatComplex_ptr dA, magma_int_t ldda,
    magmaFloatComplex *tau, magmaFloatComplex_ptr dT,
    magma_int_t *info,
    ...
    magma_queue_t queues[2] )
{
    ...
    if (nb <= 1 || nb >= minmn) {
        h_workspace_bytes += 2*m*n*sizeof(magmaFloatComplex);
    }
    else {
        h_workspace_bytes += lwork * sizeof(magmaFloatComplex);
    }
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= minmn) {
        ...
        magma_cgetmatrix(m, n, dA, ldda, work, m, queues[0] );
        lhwork = m*n;
        lapackf77_cgeqrf( &m, &n, work, &m, tau, work+m*n, &lhwork, info );
        magma_csetmatrix( m, n, work, m, dA, ldda, queues[0] );
        return *info;
    }
