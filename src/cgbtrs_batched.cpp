/*
   ...
   @generated from src/zgbtrs_batched.cpp, normal z -> c, Mon Oct 28 11:11:58 2024
*/
...
#define dB_array(i, j)    dB_array, i, j
    ...
    gbtrs_lower_info = magmablas_cgbtrs_lower_blocked_batched(
                        n, kl, ku, nrhs,
    ...
    if( gbtrs_lower_info != 0) {
        ...
        for(magma_int_t j = 0; j < n; j++) {
            // swap
            magmablas_cgbtrs_swap_batched(nrhs, dB_array, lddb, dipiv_array, j, batchCount, queue);
...
#define dB_array(i, j)    dB_array, i, j
    ...
    gbtrs_upper_info = magmablas_cgbtrs_upper_blocked_batched(
                        n, kl, ku, nrhs,
                        dA_array, ldda,
                        dB_array, lddb,
                        batchCount, queue );
...
/// @see magma_cgbtrs_batched. This is the (pointer + stride) interface of magma_cgbtrs_batched
extern "C" magma_int_t
magma_cgbtrs_batched_strided(
    magma_trans_t transA,
    magma_int_t n, magma_int_t kl, magma_int_t ku, magma_int_t nrhs,
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magmaFloatComplex** dB_array   = (magmaFloatComplex**)queue->get_dAarray();
