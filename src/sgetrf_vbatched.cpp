/*
   ...
   @generated from src/zgetrf_vbatched.cpp, normal z -> s, Mon Oct 28 11:12:01 2024
*/
...
#define dipiv_array(i_)    dipiv_array, i_
    ...
    for (i = 0; i < max_minmn; i += nb) {
        ...
        // panel
        arginfo = magma_sgetrf_recpanel_vbatched(
                    m, n, minmn,
        ...
        if ( (i + ib) < max_n){
            ...
            if ( (i + ib) < max_m){
                ...
                magmablas_sgemm_vbatched_core(
                        ...
                        m, n, minmn,
                        MAGMA_S_NEG_ONE, dA_array(i+ib, i   ), ldda,
                                         dA_array(i   , i+ib), ldda,
                        MAGMA_S_ONE,     dA_array(i+ib, i+ib), ldda,
                        batchCount, queue );
...
/***************************************************************************//**
    ...
    dA_array    Array of pointers on the GPU, dimension (batchCount).
            Each is a REAL array on the GPU, dimension (LDDA[i],N[i]).
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    // split workspace as needed by magma_sgetrf_vbatched_max_nocheck
    ...
    // call magma_sgetrf_vbatched_max_nocheck
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if (arginfo != 0) {
        ...
        arginfo = magma_sgetrf_vbatched_max_nocheck_work(
                    m, n,
                    max_m, max_n, max_minmn, max_mxn,
                    dA_array, ldda,
