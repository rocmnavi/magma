/*
    -- MAGMA (version 2.0) --
       ...
       @author Mark Gates
       @generated from interface_hip/blas_z_v2.cpp, normal z -> s, Mon Oct 28 11:12:02 2024
*/
...
/*#ifdef PRECISION_z
  ...
  #else
    typedef hipblasFloatComplex float;
  #endif
    ...
    magma_queue_t queue )
{
    ...
    hipblasIsamax( queue->hipblas_handle(), int(n), (float*)dx, int(incx), &result );
    return result;
}
...
{
    int result; /* not magma_int_t */
    hipblasIsamin( queue->hipblas_handle(), int(n), (float*)dx, int(incx), &result );
    return result;
}
...
{
    float result;
    hipblasSasum( queue->hipblas_handle(), int(n), (float*)dx, int(incx), &result );
    return result;
}
...
magma_saxpy(
    ...
    magma_queue_t queue )
{
    hipblasSaxpy( queue->hipblas_handle(), int(n), (float*)&alpha, (float*)dx, int(incx), (float*)dy, int(incy) );
}
...
magma_scopy(
    ...
    magma_queue_t queue )
{
    hipblasScopy( queue->hipblas_handle(), int(n), (float*)dx, int(incx), (float*)dy, int(incy) );
}
...
{
    float result;
    hipblasSdot( queue->hipblas_handle(), int(n), (float*)dx, int(incx), (float*)dy, int(incy), (float*)&result );
    return result;
}
#endif // COMPLEX
...
{
    float result;
    hipblasSnrm2( queue->hipblas_handle(), int(n), (float*)dx, int(incx), &result );
    return result;
}
...
magma_srot(
    ...
    magma_queue_t queue )
{
    hipblasSrot( queue->hipblas_handle(), int(n), (float*)dx, int(incx), (float*)dy, int(incy), &c, (float*)&s );
}
...
magma_srot(
    ...
    magma_queue_t queue )
{
    hipblasSrot( queue->hipblas_handle(), int(n), (float*)dx, int(incx), (float*)dy, int(incy), &c, &s );
}
#endif // COMPLEX
...
magma_srotg(
    ...
    magma_queue_t queue )
{
    hipblasSrotg( queue->hipblas_handle(), (float*)a, (float*)b, c, (float*)s );
}
...
magma_srotm(
    ...
    magma_queue_t queue )
{
    hipblasSrotm( queue->hipblas_handle(), int(n), dx, int(incx), dy, int(incy), param );
}
#endif // REAL
...
magma_srotmg(
    ...
    magma_queue_t queue )
{
    hipblasSrotmg( queue->hipblas_handle(), d1, d2, x1, y1, param );
}
#endif // REAL
...
magma_sscal(
    ...
    magma_queue_t queue )
{
    hipblasSscal( queue->hipblas_handle(), int(n), (float*)&alpha, (float*)dx, int(incx) );
}
...
magma_sscal(
    ...
    magma_queue_t queue )
{
    hipblasSscal( queue->hipblas_handle(), int(n), &alpha, (float*)dx, int(incx) );
}
#endif // COMPLEX
...
magma_sswap(
    ...
    magma_queue_t queue )
{
    hipblasSswap( queue->hipblas_handle(), int(n), (float*)dx, int(incx), (float*)dy, int(incy) );
}
