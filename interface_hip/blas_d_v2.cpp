/*
    -- MAGMA (version 2.0) --
       ...
       @author Mark Gates
       @generated from interface_hip/blas_z_v2.cpp, normal z -> d, Mon Oct 28 11:12:02 2024
*/
...
/*#ifdef PRECISION_z
  ...
  #else
    typedef hipblasFloatComplex double;
  #endif
    ...
    magma_queue_t queue )
{
    ...
    hipblasIdamax( queue->hipblas_handle(), int(n), (double*)dx, int(incx), &result );
    return result;
}
...
{
    int result; /* not magma_int_t */
    hipblasIdamin( queue->hipblas_handle(), int(n), (double*)dx, int(incx), &result );
    return result;
}
...
{
    double result;
    hipblasDasum( queue->hipblas_handle(), int(n), (double*)dx, int(incx), &result );
    return result;
}
...
magma_daxpy(
    ...
    magma_queue_t queue )
{
    hipblasDaxpy( queue->hipblas_handle(), int(n), (double*)&alpha, (double*)dx, int(incx), (double*)dy, int(incy) );
}
...
magma_dcopy(
    ...
    magma_queue_t queue )
{
    hipblasDcopy( queue->hipblas_handle(), int(n), (double*)dx, int(incx), (double*)dy, int(incy) );
}
...
{
    double result;
    hipblasDdot( queue->hipblas_handle(), int(n), (double*)dx, int(incx), (double*)dy, int(incy), (double*)&result );
    return result;
}
#endif // COMPLEX
...
{
    double result;
    hipblasDnrm2( queue->hipblas_handle(), int(n), (double*)dx, int(incx), &result );
    return result;
}
...
magma_drot(
    ...
    magma_queue_t queue )
{
    hipblasDrot( queue->hipblas_handle(), int(n), (double*)dx, int(incx), (double*)dy, int(incy), &c, (double*)&s );
}
...
magma_drot(
    ...
    magma_queue_t queue )
{
    hipblasDrot( queue->hipblas_handle(), int(n), (double*)dx, int(incx), (double*)dy, int(incy), &c, &s );
}
#endif // COMPLEX
...
magma_drotg(
    ...
    magma_queue_t queue )
{
    hipblasDrotg( queue->hipblas_handle(), (double*)a, (double*)b, c, (double*)s );
}
...
magma_drotm(
    ...
    magma_queue_t queue )
{
    hipblasDrotm( queue->hipblas_handle(), int(n), dx, int(incx), dy, int(incy), param );
}
#endif // REAL
...
magma_drotmg(
    ...
    magma_queue_t queue )
{
    hipblasDrotmg( queue->hipblas_handle(), d1, d2, x1, y1, param );
}
#endif // REAL
...
magma_dscal(
    ...
    magma_queue_t queue )
{
    hipblasDscal( queue->hipblas_handle(), int(n), (double*)&alpha, (double*)dx, int(incx) );
}
...
magma_dscal(
    ...
    magma_queue_t queue )
{
    hipblasDscal( queue->hipblas_handle(), int(n), &alpha, (double*)dx, int(incx) );
}
#endif // COMPLEX
...
magma_dswap(
    ...
    magma_queue_t queue )
{
    hipblasDswap( queue->hipblas_handle(), int(n), (double*)dx, int(incx), (double*)dy, int(incy) );
}
