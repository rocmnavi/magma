...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zlascl_2x2.hip.cpp, normal z -> c, Fri Aug 25 13:16:57 2023
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    if (type == MagmaLower) {
        hipLaunchKernelGGL(clascl_2x2_lower, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, dW, lddw, dA, ldda);
    }
    else {
        hipLaunchKernelGGL(clascl_2x2_upper, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, dW, lddw, dA, ldda);
    }
}
