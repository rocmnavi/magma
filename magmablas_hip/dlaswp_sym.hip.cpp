...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zlaswp_sym.hip.cpp, normal z -> d, Fri Aug 25 13:16:58 2023
...
extern "C" void dlaswp_sym( dlaswp_sym_params_t &params, magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dlaswp_sym_kernel, dim3(blocks), dim3(NTHREADS), 0, queue->hip_stream() ,  params );
}
