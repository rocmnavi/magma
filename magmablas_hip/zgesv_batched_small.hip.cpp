    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if(use_shmem_kernel == 1) {
        ...
        if ( thread_x > nthreads_max || shmem > shmem_max ) {
            ...
            e = hipLaunchKernel((void*)zgesv_batched_small_sm_kernel, grid, threads, kernel_args, shmem, queue->hip_stream());
        }
    }
    else {
        void *kernel_args[] = {&dA_array, &ldda, &dipiv_array, &dB_array, &lddb, &dinfo_array};
        switch(n){
            case  1: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 1>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  2: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 2>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  3: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 3>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  4: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 4>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  5: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 5>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  6: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 6>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  7: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 7>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  8: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 8>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case  9: e = hipLaunchKernel((void*)zgesv_batched_small_kernel< 9>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 10: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<10>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 11: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<11>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 12: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<12>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 13: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<13>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 14: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<14>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 15: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<15>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 16: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<16>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 17: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<17>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 18: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<18>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 19: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<19>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 20: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<20>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 21: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<21>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 22: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<22>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 23: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<23>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 24: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<24>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 25: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<25>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 26: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<26>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 27: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<27>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 28: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<28>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 29: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<29>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 30: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<30>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 31: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<31>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
            case 32: e = hipLaunchKernel((void*)zgesv_batched_small_kernel<32>, grid, threads, kernel_args, shmem, queue->hip_stream()); break;
