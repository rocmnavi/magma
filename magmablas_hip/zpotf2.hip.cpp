    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_zdotc, dim3(1), dim3(threadSize), shmem, queue->hip_stream() , n, x, incx, threadSize);
}
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_zdscal, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    dim3 grid(num_blocks,1);
    hipLaunchKernelGGL(kernel_zlacgv, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
