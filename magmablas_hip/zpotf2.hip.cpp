    ...
    int step, magma_int_t* device_info, magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(zpotf2_zdotc_kernel, dim3(1), dim3(threadSize), shmem, queue->hip_stream() , n, x, incx, threadSize, step, device_info);
}
    ...
    magma_int_t* device_info, magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(zpotf2_zdscal_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx, device_info);
}
    ...
    magma_queue_t queue )
{
    ...
    dim3 grid(num_blocks,1);
    hipLaunchKernelGGL(zpotf2_zlacgv_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
