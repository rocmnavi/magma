...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zset_pointer.hip.cpp, normal z -> c, Thu Jan 25 22:58:04 2024
       @author Azzam Haidar
...
void magma_cset_pointer(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_cset_pointer, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
/******************************************************************************/
extern "C"
void magma_cset_pointer_var_cc(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_cset_pointer_var, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
