...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zgeadd.hip.cpp, normal z -> s, Fri Aug 25 13:16:51 2023
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sgeadd_full, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, dA, ldda, dB, lddb );
}
