...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlaqps2_gpu.hip.cpp, normal z -> s, Mon Oct 28 11:12:06 2024
...
#define dF(i_, j_) (dF + (i_) + (j_)*(lddf))
    ...
    while( k < nb && lsticc == 0 ) {
        ...
        if (k > 0) {
            ...
            hipLaunchKernelGGL(magma_sgemv_kernel3, dim3(k), dim3(BLOCK_SIZE), 0, queue->hip_stream() , m-rk, dA(rk, 0), ldda, dA(rk, k), dauxv, dtau+k);
