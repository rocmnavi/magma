...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlaswp_batched.hip.cpp, normal z -> d, Mon Oct 28 11:12:20 2024
                   ...
                   magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(dlaswp_rowserial_kernel_batched, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA_array+i, lda, k1, k2, ipiv_array+i);
    }
}
                   ...
                   magma_int_t* dipiv, magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(dlaswp_rowserial_kernel_native, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA, lda, k1, k2, dipiv);
}
