...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlarf_batched_fused_sm.hip.cpp, normal z -> d, Thu Jan 25 22:58:03 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    hipError_t e = hipLaunchKernel((void*)dlarf_fused_sm_kernel_batched<NB>, grid, threads, kernel_args, shmem, queue->hip_stream());
    if( e != hipSuccess ) {
