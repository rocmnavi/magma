...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zpotf2.hip.cpp, normal z -> d, Fri Aug 25 13:17:05 2023
*/
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_ddot, dim3(1), dim3(threadSize), shmem, queue->hip_stream() , n, x, incx, threadSize);
}
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_dscal, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    dim3 grid(num_blocks,1);
    hipLaunchKernelGGL(kernel_dlacgv, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
