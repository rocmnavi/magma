...
/*                                                                                                     
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zdiinertia.hip.cpp, normal z -> d, Mon Oct 28 11:12:03 2024
...
__global__ void
ddiinertia_kernel(int n, magmaDouble_const_ptr dA, int ldda, int *dneig)
{
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(ddiinertia_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA, ldda, dneig);
