...
/*
   ...
   @generated from magmablas_hip/zposv_irgmres_kernels.hip.cpp, normal z -> c, Mon Jul 15 16:57:52 2024
    ...
    magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(cscal_shift_hpd_kernel<DIMX, DIMY>), dim3(grid), dim3(threads), 0, queue->hip_stream(), uplo, n, dA, ldda, dD, incd, miu, cn, eps);
}
