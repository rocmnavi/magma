...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zgemv_conj.hip.cpp, normal z -> d, Fri Aug 25 13:16:52 2023
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dgemv_conj_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, alpha, dA, ldda, dx, incx, beta, dy, incy);
}
