...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zpotf2.hip.cpp, normal z -> c, Thu Jan 25 22:57:59 2024
*/
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_cdotc, dim3(1), dim3(threadSize), shmem, queue->hip_stream() , n, x, incx, threadSize);
}
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_csscal, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    dim3 grid(num_blocks,1);
    hipLaunchKernelGGL(kernel_clacgv, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx);
}
