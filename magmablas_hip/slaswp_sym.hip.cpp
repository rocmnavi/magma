...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlaswp_sym.hip.cpp, normal z -> s, Thu Jan 25 22:57:55 2024
...
extern "C" void slaswp_sym( slaswp_sym_params_t &params, magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(slaswp_sym_kernel, dim3(blocks), dim3(NTHREADS), 0, queue->hip_stream() ,  params );
}
