...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgeadd_batched.hip.cpp, normal z -> c, Thu Jan 25 22:58:00 2024
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(cgeadd_batched_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, alpha, dAarray+i, ldda, dBarray+i, lddb );
    }
}
