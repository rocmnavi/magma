...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zswapdblk.hip.cpp, normal z -> s, Thu Jan 25 22:57:55 2024
    ...
    magma_queue_t queue )
{
    ...
    if ( nblocks > 0 ) {
        hipLaunchKernelGGL(sswapdblk_kernel, dim3(nblocks), dim3(nb), 0, queue->hip_stream() ,  nb, dA, ldda, inca,
                  dB, lddb, incb );
    }
}
