...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zswap.hip.cpp, normal z -> c, Mon Jul 15 16:57:41 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cswap_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  n, dx, incx, dy, incy );
}
