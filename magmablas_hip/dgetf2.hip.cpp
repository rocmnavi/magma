...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgetf2.hip.cpp, normal z -> d, Thu Jan 25 22:57:59 2024
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_dswap, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, i, j, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_dscal_dger, dim3(grid), dim3(threads), shared_size, queue->hip_stream() , m, n, dA, ldda);
}
