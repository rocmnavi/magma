/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zsymm.hip.cpp, normal z -> s, Thu Jan 25 22:57:56 2024
...
/***************************************************************************//**
    ...
    @param[in]
    dA      REAL array A of DIMENSION ( ldda, ka ), where ka is
    ...
    @param[in]
    dB      REAL array B of DIMENSION ( lddb, n ).
    ...
    @param[in,out]
    dC      REAL array C of DIMENSION ( lddc, n ).
    ...
    magma_queue_t queue )
{
    ...
    if( side == MagmaLeft ) { 
        hemm_template<float, SYMM_LEFT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
    else {
        hemm_template<float, SYMM_RIGHT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
}
