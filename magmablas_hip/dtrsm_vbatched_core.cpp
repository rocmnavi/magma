/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/ztrsm_vbatched_core.cpp, normal z -> d, Thu Jan 25 22:58:06 2024
...
magma_int_t magma_get_dtrsm_vbatched_nb(magma_int_t max_n)
{
...
#define dB_array(i,j) dB_array, i, j
    ...
    const double c_neg_ialpha = MAGMA_D_DIV(c_negone, alpha);
    ...
    magma_int_t batrsm_stop_nb = magma_get_dtrsm_batched_stop_nb(side, max_m, max_n);
    // stopping condition
    ...
    switch(shape)
    {
        case 0: // lNl
            {
                const int m2 = magma_get_dtrsm_vbatched_nb(max_m);
        ...
        case 1: // lNU
            {
                const int m1 = magma_get_dtrsm_vbatched_nb(max_m);
        ...
        case 4: // rNL
             {
                const int n2 = magma_get_dtrsm_vbatched_nb(max_n);
        ...
        case 5: // rNU
            {
                const int n1 = magma_get_dtrsm_vbatched_nb(max_n);
