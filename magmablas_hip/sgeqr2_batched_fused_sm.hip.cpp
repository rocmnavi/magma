...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgeqr2_batched_fused_sm.hip.cpp, normal z -> s, Thu Jan 25 22:58:01 2024
*/
    ...
    magma_int_t *info_array, magma_int_t batchCount)
{
    ...
    for(int j = 0; j < N; j++){
        ...
        sgeqr2_compute_norm(M-j, &sA(j,j), snorm, tx, ntx);
        ...
        // have the diagonal
        tmp = (tx == j) ? MAGMA_S_MAKE(beta, MAGMA_D_ZERO) : sA(tx, j);
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    hipError_t e = hipLaunchKernel((void*)sgeqr2_fused_sm_kernel_batched, grid, threads, kernel_args, shmem, queue->hip_stream());
    if( e != hipSuccess ) {
