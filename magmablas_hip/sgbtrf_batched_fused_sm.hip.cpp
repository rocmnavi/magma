...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgbtrf_batched_fused_sm.hip.cpp, normal z -> s, Thu Jan 25 22:58:00 2024
*/
...
////////////////////////////////////////////////////////////////////////////////
__global__ void
sgbtrf_batched_kernel_fused_sm(
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    magma_int_t shmem  = 0;
    shmem += sldab * n * sizeof(float); // sAB
    ...
    if (shmem <= shmem_max) {
        cudaFuncSetAttribute(sgbtrf_batched_kernel_fused_sm, cudaFuncAttributeMaxDynamicSharedMemorySize, shmem);
    }
    #else
    ...
    hipError_t e = hipLaunchKernel((void*)sgbtrf_batched_kernel_fused_sm, grid, threads, kernel_args, shmem, queue->hip_stream());
    if( e != hipSuccess ) {
