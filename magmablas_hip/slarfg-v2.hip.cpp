...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlarfg-v2.hip.cpp, normal z -> s, Mon Oct 28 11:12:06 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_slarfg_gpu_kernel, dim3(blocks), dim3(threads), 0, queue->hip_stream() , n, dx0, dx, dtau, dxnorm, dAkk);
}
