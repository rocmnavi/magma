/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zhemm.hip.cpp, normal z -> c, Thu Jan 25 22:57:50 2024
    ...
    magma_queue_t queue )	
{
    ...
    if( side == MagmaLeft ) { 
        hemm_template<magmaFloatComplex, HEMM_LEFT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
    else {
        hemm_template<magmaFloatComplex, HEMM_RIGHT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
}
#endif
