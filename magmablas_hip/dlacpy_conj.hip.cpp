...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlacpy_conj.hip.cpp, normal z -> d, Mon Oct 28 11:12:05 2024
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(dlacpy_conj_kernel, dim3(blocks), dim3(threads), 0, queue->hip_stream() ,  n, dA1, lda1, dA2, lda2 );
}
