/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/magmablas_z_v1.cpp, normal z -> d, Mon Oct 28 11:12:13 2024
...
{
    magmablas_dprbt_mv(n, nrhs, dv, db, lddb, magmablasGetQueue() );
}
...
{
    magmablas_dprbt_mtv(n, nrhs, du, db, lddb, magmablasGetQueue() );
}
