...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/clag2z.hip.cpp, mixed zc -> ds, Fri Aug 25 13:16:55 2023
       @author Mark Gates
*/
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    hipLaunchKernelGGL(slag2d_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, SA, ldsa, A, lda );
}
