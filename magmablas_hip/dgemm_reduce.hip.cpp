...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zgemm_reduce.hip.cpp, normal z -> d, Fri Aug 25 13:16:51 2023
    ...
    magma_queue_t queue )
{
    ...
    if ( arch < 200  ) {
        ...
        hipLaunchKernelGGL(HIP_KERNEL_NAME(dgemm_reduce_kernel<BLK_K>), dim3(blocks), dim3(threads), 0, queue->hip_stream() ,  m, n, k, alpha, dA, ldda, dB, lddb, beta, dC, lddc );
    }
    else 
