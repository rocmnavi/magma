    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(HIP_KERNEL_NAME(hemv_diag_template_batched_kernel<T, NB, TY>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  uplo, n,
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(HIP_KERNEL_NAME(hemv_lower_template_batched_kernel<T, NB, TY>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  n, alpha,
          dA_array+i, ldda,
          dX_array+i, incx,
          dY_array+i, incy,
          offA, offX, offY );
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(HIP_KERNEL_NAME(hemv_upper_template_batched_kernel<T, NB, TY>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  n, alpha,
          dA_array+i, ldda,
          dX_array+i, incx,
          dY_array+i, incy,
          offA, offX, offY);
