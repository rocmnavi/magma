...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zlarfg-v2.hip.cpp, normal z -> c, Fri Aug 25 13:16:56 2023
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(magma_clarfg_gpu_kernel, dim3(blocks), dim3(threads), 0, queue->hip_stream() , n, dx0, dx, dtau, dxnorm, dAkk);
}
