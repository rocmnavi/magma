                   ...
                   magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        hipLaunchKernelGGL(zlaswp_rowserial_kernel_batched, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA_array+i, lda, k1, k2, ipiv_array+i);
    }
}
                   ...
                   magma_int_t* dipiv, magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(zlaswp_rowserial_kernel_native, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA, lda, k1, k2, dipiv);
}
