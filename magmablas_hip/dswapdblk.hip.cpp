...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zswapdblk.hip.cpp, normal z -> d, Mon Oct 28 11:12:10 2024
    ...
    magma_queue_t queue )
{
    ...
    if ( nblocks > 0 ) {
        hipLaunchKernelGGL(dswapdblk_kernel, dim3(nblocks), dim3(nb), 0, queue->hip_stream() ,  nb, dA, ldda, inca,
                  dB, lddb, incb );
    }
}
