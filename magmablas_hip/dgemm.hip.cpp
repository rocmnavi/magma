...
magmablas_dgemm(
    ...
    double alpha,
    double const * dA, magma_int_t ldda,
    double const * dB, magma_int_t lddb,
    double beta,
    ...
    magma_queue_t queue )
{
    ...
    switch(shape)
    {
        case 0: // nn
            {
                gemm_template_nn
                <double, DIM_X, DIM_Y, BLK_M_nn, BLK_N_nn, BLK_K_nn, DIM_XA_nn, DIM_YA_nn, DIM_XB_nn, DIM_YB_nn, 0, 0>
        ...
        case 2: // nc
            {
                gemm_template_nt
                <double, DIM_X, DIM_Y, BLK_M_nt, BLK_N_nt, BLK_K_nt, DIM_XA_nt, DIM_YA_nt, DIM_XB_nt, DIM_YB_nt, 0, 0>
                (m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
            }
            break;
        case 3: // tn
        case 6: // cn
            {
                gemm_template_tn
                <double, DIM_X, DIM_Y, BLK_M_tn, BLK_N_tn, BLK_K_tn, DIM_XA_tn, DIM_YA_tn, DIM_XB_tn, DIM_YB_tn, 0, 0>
                (m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
            }
            break;
        case 4: // tt
        ...
        case 8: // cc
            {
                gemm_template_tt
                <double, DIM_X, DIM_Y, BLK_M_tt, BLK_N_tt, BLK_K_tt, DIM_XA_tt, DIM_YA_tt, DIM_XB_tt, DIM_YB_tt, 0, 0>
                (m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
            }
            break;
