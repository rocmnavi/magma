...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zlarfg.hip.cpp, normal z -> s, Fri Aug 25 13:16:56 2023
    ...
    magma_queue_t queue )
{
    dim3 threads( NB );
    dim3 blocks( 1 );
    hipLaunchKernelGGL(slarfg_kernel, dim3(blocks), dim3(threads), 0, queue->hip_stream() ,  n, dalpha, dx, incx, dtau );
}
