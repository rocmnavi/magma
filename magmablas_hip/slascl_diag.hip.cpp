...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlascl_diag.hip.cpp, normal z -> s, Thu Jan 25 22:57:54 2024
*/
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    if (type == MagmaLower) {
        hipLaunchKernelGGL(slascl_diag_lower, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, dD, lddd, dA, ldda);
    }
    else if (type == MagmaUpper) {
        hipLaunchKernelGGL(slascl_diag_upper, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, dD, lddd, dA, ldda);
    }
}
