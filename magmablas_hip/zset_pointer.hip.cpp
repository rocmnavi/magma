...
void magma_zset_pointer(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_zset_pointer, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
/******************************************************************************/
extern "C"
void magma_zset_pointer_var_cc(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_zset_pointer_var, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
