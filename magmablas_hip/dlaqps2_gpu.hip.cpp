...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlaqps2_gpu.hip.cpp, normal z -> d, Thu Jan 25 22:57:52 2024
...
#define dF(i_, j_) (dF + (i_) + (j_)*(lddf))
    ...
    while( k < nb && lsticc == 0 ) {
        ...
        if (k > 0) {
            ...
            hipLaunchKernelGGL(magma_dgemv_kernel3, dim3(k), dim3(BLOCK_SIZE), 0, queue->hip_stream() , m-rk, dA(rk, 0), ldda, dA(rk, k), dauxv, dtau+k);
