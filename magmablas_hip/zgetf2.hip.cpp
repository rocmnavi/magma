    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_zswap, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, i, j, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_zscal_zgeru, dim3(grid), dim3(threads), shared_size, queue->hip_stream() , m, n, dA, ldda);
}
