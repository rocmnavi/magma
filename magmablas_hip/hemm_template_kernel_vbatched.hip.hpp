    ...
    if( side == MagmaLeft ){
        if(uplo == MagmaLower){
            for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
                ...
                hipLaunchKernelGGL(HIP_KERNEL_NAME(hemm_template_vbatched_ll_kernel<T, DIM, BLK_M, BLK_N, CONJA>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m+i, n+i, dA_array+i, ldda+i, dB_array+i, lddb+i, dC_array+i, lddc+i,
            ...
            for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
                ...
                hipLaunchKernelGGL(HIP_KERNEL_NAME(hemm_template_vbatched_lu_kernel<T, DIM, BLK_M, BLK_N, CONJA>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m+i, n+i, dA_array+i, ldda+i, dB_array+i, lddb+i, dC_array+i, lddc+i,
                  alpha, beta, roffA, coffA, roffB, coffB, roffC, coffC, specM, specN );
            }
        }
    }else{
        if(uplo == MagmaLower){
            for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
                ...
                hipLaunchKernelGGL(HIP_KERNEL_NAME(hemm_template_vbatched_rl_kernel<T, DIM, BLK_M, BLK_N, CONJA>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m+i, n+i, dA_array+i, ldda+i, dB_array+i, lddb+i, dC_array+i, lddc+i,
                  alpha, beta, roffA, coffA, roffB, coffB, roffC, coffC, specM, specN );
            }
        }else{
            for(magma_int_t i = 0; i < batchCount; i+=max_batchCount){
                ...
                hipLaunchKernelGGL(HIP_KERNEL_NAME(hemm_template_vbatched_ru_kernel<T, DIM, BLK_M, BLK_N, CONJA>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m+i, n+i, dA_array+i, ldda+i, dB_array+i, lddb+i, dC_array+i, lddc+i,
                  alpha, beta, roffA, coffA, roffB, coffB, roffC, coffC, specM, specN );
            }
        }
    }
