/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zsymm.hip.cpp, normal z -> d, Mon Oct 28 11:12:10 2024
...
/***************************************************************************//**
    ...
    @param[in]
    dA      DOUBLE PRECISION array A of DIMENSION ( ldda, ka ), where ka is
    ...
    @param[in]
    dB      DOUBLE PRECISION array B of DIMENSION ( lddb, n ).
    ...
    @param[in,out]
    dC      DOUBLE PRECISION array C of DIMENSION ( lddc, n ).
    ...
    magma_queue_t queue )
{
    ...
    if( side == MagmaLeft ) { 
        hemm_template<double, SYMM_LEFT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
    else {
        hemm_template<double, SYMM_RIGHT>
        (side, uplo, m, n, dA, ldda, dB, lddb, dC, lddc, alpha, beta, queue);
    }
}
