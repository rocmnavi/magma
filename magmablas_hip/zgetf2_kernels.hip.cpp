...
#include "zgetf2_devicefunc.hip.hpp"
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(izamax_kernel_batched, dim3(grid), dim3(threads), zamax * (sizeof(double) + sizeof(int)), queue->hip_stream() , length, x_array, xi, xj, lda, incx, ipiv_array, ipiv_i, info_array, step, gbstep);
    ...
    magma_int_t step, magma_int_t gbstep, magma_queue_t queue)
{
    ...
    if( length <= 15360 ) {
        ...
        hipLaunchKernelGGL(izamax_kernel_native, dim3(grid), dim3(threads), zamax * (sizeof(double) + sizeof(int)), queue->hip_stream() , length, x, incx, ipiv, info, step, gbstep);
    }
    else {
        ...
        hipblasIzamax(queue->hipblas_handle(), length, x, 1, (int*)(ipiv));
        hipLaunchKernelGGL(magma_zpivcast, dim3(1), dim3(1), 0, queue->hip_stream() ,  ipiv );
                     ...
                     magma_int_t batchCount, magma_queue_t queue)
{
    ...
    */
    ...
    hipLaunchKernelGGL(zswap_kernel_batched, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, dA_array, ai, aj, incx, step, ipiv_array);
    return 0;
}
                    ...
                    magma_queue_t queue)
{
    ...
    */
    ...
    hipLaunchKernelGGL(zswap_kernel_native, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, incx, step, ipiv);
}
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    */
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        switch(n){
            case  1: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 1>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  2: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 2>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  3: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 3>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  4: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 4>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  5: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 5>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  6: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 6>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  7: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 7>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            case  8: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_batched< 8>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);break;
            default: hipLaunchKernelGGL(zscal_zgeru_1d_generic_kernel_batched, dim3(grid), dim3(threads), 0, queue->hip_stream(), m, n, dA_array+i, ai, aj, lda, info_array+i, step, gbstep);
        }
    }
    return 0;
}
    ...
    magma_queue_t queue)
{
    ...
    */
    ...
    dim3 threads(tbx, 1, 1);
    switch(n){
        case 1: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<1>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 2: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<2>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 3: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<3>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 4: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<4>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 5: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<5>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 6: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<6>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 7: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<7>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        case 8: hipLaunchKernelGGL(HIP_KERNEL_NAME(zscal_zgeru_1d_kernel_native<8>), dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, dA, lda, info, step, gbstep);break;
        default: hipLaunchKernelGGL(zscal_zgeru_1d_generic_kernel_native, dim3(grid), dim3(threads), 0, queue->hip_stream(),  m, n, dA, lda, info, step, gbstep);
    }
    return 0;
}
...
void zgetf2trsm_kernel_batched(int ib, int n, magmaDoubleComplex **dA_array, int step, int lda)
{
    ...
    HIP_DYNAMIC_SHARED( magmaDoubleComplex, shared_data)
                         ...
                         magma_int_t batchCount, magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(zgetf2trsm_kernel_batched, dim3(grid), dim3(threads), shared_size, queue->hip_stream() , ib, n, dA_array, step, ldda);
}
    ...
    magma_queue_t queue)
{
    ...
    switch(m8){
        case  8: hipLaunchKernelGGL(HIP_KERNEL_NAME(zgetf2trsm_2d_kernel< 8>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, dA, ldda, dB, lddb ); break;
        case 16: hipLaunchKernelGGL(HIP_KERNEL_NAME(zgetf2trsm_2d_kernel<16>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, dA, ldda, dB, lddb ); break;
        case 24: hipLaunchKernelGGL(HIP_KERNEL_NAME(zgetf2trsm_2d_kernel<24>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, dA, ldda, dB, lddb ); break;
        case 32: hipLaunchKernelGGL(HIP_KERNEL_NAME(zgetf2trsm_2d_kernel<32>), dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, dA, ldda, dB, lddb ); break;
        default:;
    }
}
    ...
    magma_queue_t queue )
{
    ...
    hipError_t e = hipLaunchKernel((void*)zgetf2_fused_kernel_batched<N>, grid, threads, kernel_args, shmem, queue->hip_stream());
    if( e != hipSuccess ) {
