...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/clat2z.hip.cpp, mixed zc -> ds, Fri Aug 25 13:16:58 2023
       @author Mark Gates
*/
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    if (uplo == MagmaLower) {
        hipLaunchKernelGGL(slat2d_lower, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, SA, ldsa, A, lda);
    }
    else if (uplo == MagmaUpper) {
        hipLaunchKernelGGL(slat2d_upper, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, SA, ldsa, A, lda);
    }
}
