...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zset_pointer.hip.cpp, normal z -> d, Mon Oct 28 11:12:20 2024
       @author Azzam Haidar
...
void magma_dset_pointer(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_dset_pointer, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
/******************************************************************************/
extern "C"
void magma_dset_pointer_var_cc(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_dset_pointer_var, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
...
{
    hipLaunchKernelGGL(zdisplace_pointers_kernel, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input_array, lda, row, column);
}
/******************************************************************************/
extern "C"
...
*/
    hipLaunchKernelGGL(zdisplace_pointers_var_cc_kernel, dim3(batchCount), dim3(1), 0, queue->hip_stream(), output_array, input_array, lda, row, column);
}
/******************************************************************************/
extern "C"
...
*/
    hipLaunchKernelGGL(zdisplace_pointers_var_cv_kernel, dim3(batchCount), dim3(1), 0, queue->hip_stream(), output_array, input_array, lda, row, column);
}
/******************************************************************************/
extern "C"
...
*/
    hipLaunchKernelGGL(zdisplace_pointers_var_vc_kernel, dim3(batchCount), dim3(1), 0, queue->hip_stream(), output_array, input_array, lda, row, column);
}
/******************************************************************************/
extern "C"
...
*/
    hipLaunchKernelGGL(zdisplace_pointers_var_vv_kernel, dim3(batchCount), dim3(1), 0, queue->hip_stream(), output_array, input_array, lda, row, column);
}
