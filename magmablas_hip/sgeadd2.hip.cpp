...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgeadd2.hip.cpp, normal z -> s, Mon Oct 28 11:12:03 2024
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sgeadd2_full, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, dA, ldda, beta, dB, lddb );
}
