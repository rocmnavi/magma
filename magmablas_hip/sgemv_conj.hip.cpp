...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgemv_conj.hip.cpp, normal z -> s, Thu Jan 25 22:57:49 2024
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(sgemv_conj_kernel, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, alpha, dA, ldda, dx, incx, beta, dy, incy);
}
