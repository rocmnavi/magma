...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zgetf2.hip.cpp, normal z -> s, Fri Aug 25 13:17:05 2023
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(kernel_sswap, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, x, i, j, incx);
}
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    hipLaunchKernelGGL(kernel_sscal_sger, dim3(grid), dim3(threads), shared_size, queue->hip_stream() , m, n, dA, ldda);
}
