...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlaswp_sym.hip.cpp, normal z -> c, Mon Jul 15 16:57:41 2024
...
extern "C" void claswp_sym( claswp_sym_params_t &params, magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(claswp_sym_kernel, dim3(blocks), dim3(NTHREADS), 0, queue->hip_stream() ,  params );
}
