...
getrf_vbatched_checker(
        ...
        magma_int_t* errors, int batchCount)
{
        ...
        magma_int_t* errors, magma_int_t batchCount, magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(getrf_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , m, n, ldda, errors, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(gemm_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , transA, transB, m, n, k, ldda, lddb, lddc, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(trsm_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , side, m, n, ldda, lddb, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(herk_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , trans, n, k, ldda, lddc, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(her2k_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , trans, n, k, ldda, lddb, lddc, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(hemm_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , side, m, n, ldda, lddb, lddc, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(gemv_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , trans , m, n, ldda, incx, incy, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(hemv_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , uplo , n, ldda, incx, incy, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue)
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(axpy_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , n, incx, incy, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(trmm_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , side, m, n, ldda, lddb, batchCount);
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    dim3 grid( magma_ceildiv(batchCount, CHECKER_TX), 1, 1 );
    dim3 threads( CHECKER_TX, 1, 1 );
    hipLaunchKernelGGL(potrf_vbatched_checker, dim3(grid), dim3(threads), 0, queue->hip_stream() , uplo , n, ldda, batchCount);
