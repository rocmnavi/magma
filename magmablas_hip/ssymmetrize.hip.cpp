...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zsymmetrize.hip.cpp, normal z -> s, Thu Jan 25 22:57:56 2024
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    if ( uplo == MagmaUpper ) {
        hipLaunchKernelGGL(ssymmetrize_upper, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, dA, ldda );
    }
    else {
        hipLaunchKernelGGL(ssymmetrize_lower, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, dA, ldda );
    }
}
