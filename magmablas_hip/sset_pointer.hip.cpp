...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zset_pointer.hip.cpp, normal z -> s, Mon Jul 15 16:57:48 2024
       @author Azzam Haidar
...
void magma_sset_pointer(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_sset_pointer, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
/******************************************************************************/
extern "C"
void magma_sset_pointer_var_cc(
    ...
    magma_queue_t queue)
{
    hipLaunchKernelGGL(kernel_sset_pointer_var, dim3(batchCount), dim3(1), 0, queue->hip_stream() , output_array, input, lda,  row, column, batch_offset);
}
