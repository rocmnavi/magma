    ...
    T alpha, T beta, magma_queue_t queue)
{
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(gemm_template_nn_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N, BLK_K, DIM_XA, DIM_YA, DIM_XB, DIM_YB, CONJA, CONJB>), dim3(dimGrid), dim3(dimBlock), shmem, queue->hip_stream() , m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta);
}
    ...
    T alpha, T beta, magma_queue_t queue)
{
    ...
    dim3 dimBlock(DIM_X, DIM_Y);
    dim3 dimGrid( magma_ceildiv( m, BLK_M ), magma_ceildiv( n, BLK_N ), 1 );
    hipLaunchKernelGGL(HIP_KERNEL_NAME(gemm_template_nt_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N, BLK_K, DIM_XA, DIM_YA, DIM_XB, DIM_YB, CONJA, CONJB>), dim3(dimGrid), dim3(dimBlock), shmem, queue->hip_stream() , m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta);
}
    ...
    T alpha, T beta, magma_queue_t queue)
{
    ...
    dim3 dimBlock(DIM_X, DIM_Y);
    dim3 dimGrid( magma_ceildiv( m, BLK_M ), magma_ceildiv( n, BLK_N ), 1 );
    hipLaunchKernelGGL(HIP_KERNEL_NAME(gemm_template_tn_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N, BLK_K, DIM_XA, DIM_YA, DIM_XB, DIM_YB, CONJA, CONJB>), dim3(dimGrid), dim3(dimBlock), shmem, queue->hip_stream() , m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta);
}
    ...
    T alpha, T beta, magma_queue_t queue)
{
    ...
    dim3 dimBlock(DIM_X, DIM_Y);
    dim3 dimGrid( magma_ceildiv( m, BLK_M ), magma_ceildiv( n, BLK_N ), 1 );
    hipLaunchKernelGGL(HIP_KERNEL_NAME(gemm_template_tt_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N, BLK_K, DIM_XA, DIM_YA, DIM_XB, DIM_YB, CONJA, CONJB>), dim3(dimGrid), dim3(dimBlock), shmem, queue->hip_stream() , m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta);
}
