...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgemv_batched_smallsq.hip.cpp, normal z -> d, Mon Oct 28 11:12:18 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if( transA == MagmaNoTrans ) {
        ...
        hipError_t e = hipLaunchKernel((void*)dgemvn_batched_smallsq_kernel<double, N>, grid, threads, kernel_args, shmem, queue->hip_stream());
        if( e != hipSuccess ) {
            return -100;
        }
    }
        ...
        void *kernel_args[] = {
                ...
                (void*)&alpha, (void*)&dA_array, (void*)&dA, &ldda, &strideA,
                               (void*)&dx_array, (void*)&dx, &incx, &stridex,
                (void*)&beta,         &dy_array,        &dy, &incy, &stridey, &batchCount};
        hipError_t e = hipLaunchKernel((void*)dgemvc_batched_smallsq_kernel<double, N>, grid, threads, kernel_args, shmem, queue->hip_stream());
        if( e != hipSuccess ) {
            return -100;
        }
    }
