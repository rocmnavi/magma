...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgbtrf_batched_fused_sm.hip.cpp, normal z -> d, Mon Oct 28 11:12:15 2024
*/
...
////////////////////////////////////////////////////////////////////////////////
__global__ void
dgbtrf_batched_kernel_fused_sm(
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    magma_int_t shmem  = 0;
    shmem += sldab * n * sizeof(double); // sAB
    ...
    if (shmem <= shmem_max) {
        cudaFuncSetAttribute(dgbtrf_batched_kernel_fused_sm, cudaFuncAttributeMaxDynamicSharedMemorySize, shmem);
    }
    #else
    ...
    hipError_t e = hipLaunchKernel((void*)dgbtrf_batched_kernel_fused_sm, grid, threads, kernel_args, shmem, queue->hip_stream());
    if( e != hipSuccess ) {
