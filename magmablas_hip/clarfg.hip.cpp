...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zlarfg.hip.cpp, normal z -> c, Mon Oct 28 11:12:08 2024
    ...
    magma_queue_t queue )
{
    dim3 threads( NB );
    dim3 blocks( 1 );
    hipLaunchKernelGGL(clarfg_kernel, dim3(blocks), dim3(threads), 0, queue->hip_stream() ,  n, dalpha, dx, incx, dtau );
}
