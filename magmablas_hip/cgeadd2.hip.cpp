...
/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas_hip/zgeadd2.hip.cpp, normal z -> c, Fri Aug 25 13:16:51 2023
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cgeadd2_full, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, dA, ldda, beta, dB, lddb );
}
