...
/*
    -- MAGMA (version 2.0) --
       ...
       @generated from magmablas_hip/zgeadd.hip.cpp, normal z -> c, Mon Oct 28 11:12:03 2024
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    hipLaunchKernelGGL(cgeadd_full, dim3(grid), dim3(threads), 0, queue->hip_stream() ,  m, n, alpha, dA, ldda, dB, lddb );
}
