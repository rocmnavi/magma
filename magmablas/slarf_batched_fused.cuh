/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zlarf_batched_fused.cuh, normal z -> s, Fri Aug 25 13:19:38 2023
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)slarf_fused_reg_kernel_batched<M32, NB, TPC>, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
