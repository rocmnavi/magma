/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zgetf2_kernels.cu, normal z -> s, Fri Aug 25 13:18:49 2023
*/
    ...
    magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)sgetf2_fused_kernel_batched<N>, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
