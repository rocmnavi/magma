/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zlat2c.cu, mixed zc -> ds, Fri Aug 25 13:18:39 2023
       @author Mark Gates
*/
    ...
    magma_int_t *info )
{
    *info = 0;
    ...
    cudaMemcpyToSymbol( magma_dlat2s_flag, info, sizeof(magma_dlat2s_flag) );    // magma_dlat2s_flag = 0
    ...
    cudaMemcpyFromSymbol( info, magma_dlat2s_flag, sizeof(magma_dlat2s_flag) );  // info = magma_dlat2s_flag
}
