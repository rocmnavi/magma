/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zlarf_batched_fused_sm.cu, normal z -> s, Fri Aug 25 13:18:51 2023
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)slarf_fused_sm_kernel_batched<NB>, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
