/*                                                                                                     
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zheinertia.cu, normal z -> s, Fri Aug 25 13:18:33 2023 
*/
    ...
    magma_queue_t queue )
{
    ...
    if (upper)
        ssiinertia_upper_kernel<<<grid, threads, 0, queue->cuda_stream() >>>
            (n, dA, ldda, ipiv, dneig);
    else
        ssiinertia_lower_kernel<<<grid, threads, 0, queue->cuda_stream() >>>
            (n, dA, ldda, ipiv, dneig);
