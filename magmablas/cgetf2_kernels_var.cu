/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zgetf2_kernels_var.cu, normal z -> c, Fri Aug 25 13:18:57 2023
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)cgetf2_fused_sm_kernel_vbatched, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
...
{
    extern __shared__ magmaFloatComplex data[];
    const int tx = threadIdx.x;
    ...
    magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)cgetf2_fused_kernel_vbatched<max_N>, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
        //printf("error in %s : failed to launch kernel %s\n", __func__, cudaGetErrorString(e));
        arginfo = -100;
    }
