/*
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/ztrsv_batched.cu, normal z -> c, Fri Aug 25 13:18:53 2023
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        ctrsv_notrans_kernel_outplace_batched<BLOCK_SIZE, DIM_X, DIM_Y, TILE_SIZE, flag, uplo, trans, diag>
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        ctrsv_trans_kernel_outplace_batched<BLOCK_SIZE, DIM_X, DIM_Y, TILE_SIZE, flag, uplo, trans, diag>
        <<<grid, threads, shmem, queue->cuda_stream()>>>
        (n, A_array+i, lda, b_array+i, incb, x_array+i);
    }
}
