/*                                                                                                     
    -- MAGMA (version 2.7.2) --
       ...
       @generated from magmablas/zheinertia.cu, normal z -> d, Fri Aug 25 13:18:33 2023 
*/
    ...
    magma_queue_t queue )
{
    ...
    if (upper)
        dsiinertia_upper_kernel<<<grid, threads, 0, queue->cuda_stream() >>>
            (n, dA, ldda, ipiv, dneig);
    else
        dsiinertia_lower_kernel<<<grid, threads, 0, queue->cuda_stream() >>>
            (n, dA, ldda, ipiv, dneig);
